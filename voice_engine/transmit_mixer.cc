...
int32_t TransmitMixer::Create(TransmitMixer*& mixer) {
...
int32_t TransmitMixer::SetAudioProcessingModule(
...
int32_t TransmitMixer::PrepareDemux(const void* audioSamples,
                                    size_t nSamples,
                                    size_t nChannels,
  ...
  GenerateAudioFrame(static_cast<const int16_t*>(audioSamples), nSamples,
...
int32_t TransmitMixer::StopSend() {
  _audioLevel.Clear();
  return 0;
}
...
void TransmitMixer::ProcessAudio(int delay_ms,
                                 int clock_drift,
