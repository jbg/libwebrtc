...
int main(int argc, char* argv[]) {
  ...
  webrtc::IceTransactions ice_transactions;
  ...
  if (argc == 3) {
    ...
    ice_transactions = webrtc::IceTransactions::BuildIceTransactions(
    ...
    ice_transaction_analyzer.emplace(config, ice_transactions);
  }
