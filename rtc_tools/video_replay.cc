...
class RtpReplayer final {
 ...
 private:
  void ReplayPackets() {
    ...
    // When time is simulated time is first advanced up to the delivery of the
    // packet, and then the packet is inserted. To process the last packet call
    // SleepOrAdvanceTime one more time.
