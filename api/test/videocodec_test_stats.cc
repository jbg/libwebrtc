...
std::string VideoCodecTestStats::FrameStatistics::ToString() const {
  ...
  return absl::StrCat(
      ...
      " inter_layer_predicted ", inter_layer_predicted,
      " non_ref_for_inter_layer_pred ", non_ref_for_inter_layer_pred,
...
std::string VideoCodecTestStats::VideoStatistics::ToString(
  ...
  return absl::StrCat(
      ...
      prefix, "num_dropped_frames: ",
          num_input_frames - num_encoded_frames, "\n",
