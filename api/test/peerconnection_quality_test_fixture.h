...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  // Run(...) method returned). Test execution time is time from call setup
  // (offer/answer, ICE candidates exchange done and ICE connected) to call
  // tear down (PeerConnection closed).
