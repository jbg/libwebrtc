...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  //
  // If scrolling is enabled, then it will be done by purring sliding window
  // on source video and moving this window from top left corner to the
  // bottom right corner of the picture.
  //
  // To archive this extra |source_width| and |source_height| are provided.
  // Because to move window source frame should be bigger, than video stream
  // frames |source_width| and |source_height| must be greater or equal to
  // |VideoConfig::width| and |VideoConfig::height|.
  //
  // Also |source_width| and |source_height| have to be width and height of
  // videos from |ScreenShareConfig::slides_yuv_file_names|.
  //
