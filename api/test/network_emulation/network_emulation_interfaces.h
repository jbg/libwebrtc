...
class EmulatedNetworkOutgoingStats {
 public:
  ...
  // Returns counter with timestamped sizes of all sent packets.
  // Counter will contain data only with
  // EmulatedEndpointConfig::StatsGatheringMode::kDebug.
  virtual SamplesStatsCounter SentPacketsSizeCounter() const = 0;
...
class EmulatedNetworkIncomingStats {
 public:
  ...
  // Returns counter with timestamped sizes of all received packets.
  // Counter will contain data only with
  // EmulatedEndpointConfig::StatsGatheringMode::kDebug.
  virtual SamplesStatsCounter ReceivedPacketsSizeCounter() const = 0;
  ...
  // Counter will contain data only with
  // EmulatedEndpointConfig::StatsGatheringMode::kDebug.
  virtual SamplesStatsCounter DroppedPacketsSizeCounter() const = 0;
...
class EmulatedNetworkStats {
 public:
  ...
  // EmulatedEndpointConfig::StatsGatheringMode::kDebug.
  virtual SamplesStatsCounter SentPacketsSizeCounter() const = 0;
  // Returns counter with timestamped duration between packet was received on
  // network interface and was dispatched to the network in microseconds.
  // Counter will contain data only with
  // EmulatedEndpointConfig::StatsGatheringMode::kDebug.
  virtual SamplesStatsCounter SentPacketsQueueWaitTimeUs() const = 0;
