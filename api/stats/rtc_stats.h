...
enum class NonStandardGroupId {
  // I2E: https://groups.google.com/a/chromium.org/forum/#!topic/blink-dev/hE2B1iItPDk
  kRtcAudioJitterBufferMaxPackets,
  // I2E: https://groups.google.com/a/chromium.org/forum/#!topic/blink-dev/YbhMyqLXXXo
