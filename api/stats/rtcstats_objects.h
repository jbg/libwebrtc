...
class RTC_EXPORT RTCLegacyMediaStreamStats final : public RTCStats {
 public:
  WEBRTC_RTCSTATS_DECL();

  RTCLegacyMediaStreamStats(const std::string& id, int64_t timestamp_us);
  RTCLegacyMediaStreamStats(std::string&& id, int64_t timestamp_us);
  RTCLegacyMediaStreamStats(const RTCLegacyMediaStreamStats& other);
  ~RTCLegacyMediaStreamStats() override;

  RTCStatsMember<std::string> stream_identifier;
  RTCStatsMember<std::vector<std::string>> track_ids;
};
using RTCMediaStreamStats [[deprecated]] = RTCLegacyMediaStreamStats;

// TODO(https://crbug.com/webrtc/14175): Delete this class, it's deprecated.
class RTC_EXPORT RTCLegacyMediaStreamTrackStats final : public RTCStats {
 public:
  WEBRTC_RTCSTATS_DECL();

  RTCLegacyMediaStreamTrackStats(const std::string& id,
                                 int64_t timestamp_us,
                                 const char* kind);
  RTCLegacyMediaStreamTrackStats(std::string&& id,
                                 int64_t timestamp_us,
                                 const char* kind);
  RTCLegacyMediaStreamTrackStats(const RTCLegacyMediaStreamTrackStats& other);
  ~RTCLegacyMediaStreamTrackStats() override;
...
using RTCMediaStreamTrackStats [[deprecated]] = RTCLegacyMediaStreamTrackStats;
