...
class RTC_EXPORT PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  // returned by CreateOffer() or CreateAnswer(). Our implementation allows some
  // amount of "SDP munging", but please note that this is HIGHLY DISCOURAGED
  // behavior that ideally would be DEPRECATED AND REMOVED.
  //
  ...
  // operation completing and the observer getting called.
  ...
  //
  // (Unlike "SDP munging" before SetLocalDescription, modifying a remote offer
