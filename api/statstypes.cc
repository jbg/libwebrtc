...
const char* StatsReport::Value::display_name() const {
  switch (name) {
    ...
    case kStatsValueNameRecvStunKeepaliveResponses:
      return "stunKeepaliveResponsesRecv";
    case kStatsValueNameStunKeepaliveRtt:
      return "stunKeepaliveRtt";
    case kStatsValueNameStunKeepaliveRttVariance:
      return "stunKeepaliveRttVariance";
