...
#if RTC_DCHECK_IS_ON
namespace {
class InternalThreadChecker {
 public:
  InternalThreadChecker() { checker_.Detach(); }  // FromThread(); }
  bool CalledOnValidThread() const { return checker_.CalledSequentially(); }
  // return checker_.CalledOnValidThread(); }
...
#define RTC_THREAD_CHECKER_VARIABLE() InternalThreadChecker proxy_checker_
