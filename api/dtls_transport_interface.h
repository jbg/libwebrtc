...
class RTC_EXPORT DtlsTransportInformation {
 public:
  ...
  void set_tls_version(absl::optional<int> version) { tls_version_ = version; }
  absl::optional<int> ssl_cipher_suite() const { return ssl_cipher_suite_; }
  void set_ssl_cipher_suite(absl::optional<int> suite) {
    ssl_cipher_suite_ = suite;
  }
  absl::optional<int> srtp_cipher_suite() const { return srtp_cipher_suite_; }
  void set_srtp_cipher_suite(absl::optional<int> suite) {
    srtp_cipher_suite_ = suite;
  }
  ...
  void set_remote_ssl_certificates(
      std::unique_ptr<rtc::SSLCertChain> remote_ssl_certificates) {
