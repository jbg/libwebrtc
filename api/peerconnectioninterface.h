...
class PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  // Returns the aggregated state of all ICE transports. This is intended to
  // eventually replace ice_connection_state().
...
class PeerConnectionObserver {
 public:
  ...
  // Called any time the IceConnectionState changes.
  //
  // Unlike OnIceConnectionChange this one is only computed based on ICE state.
