...
struct PeerConnectionFactoryDependencies final {
  // Creates struct with default implementations of all mandatory dependencies:
  // - |audio_device_module|
  //   - Unless the |rtc_include_internal_audio_device| build arg is set to
  //     false.
  // - |audio_mixer|
  // - |audio_processing|
  // - |fec_controller_factory|
  //
  // But with *no* default implementations of audio/video encoder/decoder
  // factories. If you want WebRTC's built-in software codecs, you must
