...
// AudioChannel is made up by two implementation detail classes;
...
//    input samples from AudioDeviceModule throught AudioTransportImpl.
...
//
// Note that the instance of RtpRtcp share among all three classes.
