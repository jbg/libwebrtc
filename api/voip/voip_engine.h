...
//
//   int channel = voip_channel->CreateChannel();
//
//   // Register application's webrtc::Transport
//   voip_network->RegisterTransport(channel, ...);
//
//   // After SDP offer/answer, payload type and codec usage have been
//   // decided. Set encoder/decoder as opus for now.
...
//
//   // Stop and release voip channel and network
//   voip_network->DeRegisterTransport(channel);
