...
class RTC_EXPORT RtpTransceiverInterface : public rtc::RefCountInterface {
 public:
  ...
  // TODO(crbug.com/1051821): remove old name after Chromium roll.
  ABSL_DEPRECATED("Use GetHeaderExtensionsToNegotiate instead")
  ...
  // TODO(crbug.com/1051821): remove old name after Chromium roll.
  ABSL_DEPRECATED("Use GetNegotiatedHeaderExtensions instead")
  ...
  // TODO(crbug.com/1051821): remove old name after Chromium roll.
  ABSL_DEPRECATED("Use SetHeaderExtensionsToNegotiate instead")
