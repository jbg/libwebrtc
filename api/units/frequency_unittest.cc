...
TEST(FrequencyTest, Rounding) {
  ...
  EXPECT_EQ(freq_high.Floor(Frequency::hertz(1)), Frequency::hertz(23));
  EXPECT_EQ(freq_high.Round(Frequency::hertz(1)), Frequency::hertz(24));
  EXPECT_EQ(freq_high.Ceil(Frequency::hertz(1)), Frequency::hertz(24));

  const Frequency freq_low = Frequency::hertz(23.4);
  EXPECT_EQ(freq_low.hertz(), 23);
  EXPECT_EQ(freq_low.Floor(Frequency::hertz(1)), Frequency::hertz(23));
  EXPECT_EQ(freq_low.Round(Frequency::hertz(1)), Frequency::hertz(23));
  EXPECT_EQ(freq_low.Ceil(Frequency::hertz(1)), Frequency::hertz(24));
}
