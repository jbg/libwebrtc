 ...
 public:
  ...
  class RTC_EXPORT Builder {
   public:
    ...
    Builder& set_capture_time_identifier_us(
   ...
   private:
    ...
    absl::optional<int64_t> capture_time_identifier_us_;
  ...
  const absl::optional<int64_t>& capture_time_identifier_us() const {
    return capture_time_identifier_us_;
  }
  void set_capture_time_identifier_us(
      const absl::optional<int64_t>& capture_time_identifier_us) {
