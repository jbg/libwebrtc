...
class RTC_EXPORT VideoFrame {
 public:
  ...
  // from capturing to sending as encoded image. It intended to be unique over a
  // time window of a few minutes for peer connection, to which corresponding
  // video stream belongs to.
