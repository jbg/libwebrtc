 ...
 public:
  ...
  class Builder {
   public:
    ...
    VideoFrame build();
    std::unique_ptr<VideoFrame> buildUnique();
  ...
  // Get frame ID. Returns 0, if ID is not set. Not guarantee to be transfered
  // from sender to the receiver, but preserved on single side.
