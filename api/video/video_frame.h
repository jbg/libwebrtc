...
class RTC_EXPORT VideoFrame {
 public:
  ...
  class RTC_EXPORT Builder {
   public:
    ...
    Builder& set_capture_time_identifier(
        const absl::optional<TimeDelta>& capture_time_identifier);
   ...
   private:
    ...
    absl::optional<TimeDelta> capture_time_identifier_;
  ...
  const absl::optional<TimeDelta>& capture_time_identifier() const {
