...
rtc::scoped_refptr<VideoFrameBuffer> VideoFrameBuffer::ScaleAndCrop(
    int offset_x,
    int offset_y,
    int crop_width,
    int crop_height,
...
rtc::scoped_refptr<VideoFrameBuffer> I010BufferInterface::ScaleAndCrop(
    int offset_x,
    int offset_y,
    int crop_width,
    int crop_height,
  ...
  result->CropAndScaleFrom(*this->GetI010(), offset_x, offset_y, crop_width,
                           crop_height);
  return result;
}
...
rtc::scoped_refptr<VideoFrameBuffer> NV12BufferInterface::ScaleAndCrop(
    int offset_x,
    int offset_y,
    int crop_width,
    int crop_height,
  ...
  result->CropAndScaleFrom(*this->GetNV12(), offset_x, offset_y, crop_width,
                           crop_height);
  return result;
}
}  // namespace webrtc
