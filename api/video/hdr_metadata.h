...
struct HdrMasteringMetadata {
  ...
  // in the unit cd/m2. The value must be in the range [5, 10000] with zero
  // decimal places.
  float luminance_max = 0.0f;
  // The nominal minimum display luminance of the mastering display. Specified
  // in the unit cd/m2. The value must be in the range [0.0001, 5.0000] with
  // four decimal places.
