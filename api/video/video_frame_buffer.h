...
class RTC_EXPORT VideoFrameBuffer : public rtc::RefCountInterface {
 public:
  ...
  // A format specific scale function. Default implemantation works via by
  ...
  virtual rtc::scoped_refptr<VideoFrameBuffer> ScaleAndCrop(int offset_x,
                                                            int offset_y,
                                                            int crop_width,
                                                            int crop_height,
                                                            int scaled_width,
  ...
  rtc::scoped_refptr<VideoFrameBuffer> Scale(int scaled_width,
                                             int scaled_height) {
    return ScaleAndCrop(0, 0, width(), height(), scaled_width, scaled_height);
  }
...
class I010BufferInterface : public PlanarYuv16BBuffer {
 public:
  ...
  rtc::scoped_refptr<VideoFrameBuffer> ScaleAndCrop(int offset_x,
                                                    int offset_y,
                                                    int crop_width,
                                                    int crop_height,
                                                    int scaled_width,
