...
class MockTaskQueueBase : public TaskQueueBase {
 public:
  ...
  MOCK_METHOD1(PostTask, void(absl::AnyInvocable<void() &&>));
  MOCK_METHOD2(PostDelayedTask, void(absl::AnyInvocable<void() &&>, uint32_t));
  MOCK_METHOD2(PostDelayedHighPrecisionTask,
               void(absl::AnyInvocable<void() &&>, uint32_t));
};
