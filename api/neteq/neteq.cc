...
NetEq::Config::Config() {
  auto parser = StructParametersParser::Create(
      ...
      &enable_post_decode_vad, "max_packets_in_buffer", &max_packets_in_buffer,
      "min_delay_ms", &min_delay_ms, "max_delay_ms", &max_delay_ms,
      "enable_fast_accelerate", &enable_fast_accelerate, "enable_muted_state",
      &enable_muted_state, "enable_rtx_handling", &enable_rtx_handling);
