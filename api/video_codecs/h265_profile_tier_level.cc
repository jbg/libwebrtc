...
absl::optional<H265Profile> StringToH265Profile(absl::string_view profile) {
  const absl::optional<int> i = rtc::StringToNumber<int>(profile);
  if (!i.has_value())
    return absl::nullopt;
...
absl::optional<H265Tier> StringToH265Tier(absl::string_view tier) {
  const absl::optional<int> i = rtc::StringToNumber<int>(tier);
  if (!i.has_value())
    return absl::nullopt;
...
absl::optional<H265Level> StringToH265Level(absl::string_view level) {
