...
class VideoEncoderFactoryTemplate : public VideoEncoderFactory {
 ...
 private:
  ...
  // TODO: bugs.webrtc.org/15860 - require each trait has single CreateEncoder
  // function when VideoEncoderFactoryTemplate drop support for creating
  // VideoEncoder without providing webrtc::Environment
