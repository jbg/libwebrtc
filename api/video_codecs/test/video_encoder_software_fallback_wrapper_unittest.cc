...
TEST(SoftwareFallbackEncoderTest, BothCodecsNotWhitelisted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(false));
  EXPECT_CALL(*hw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(false));
  ...
  EXPECT_FALSE(wrapper->HasWhitelistedRateController());
}

TEST(SoftwareFallbackEncoderTest, SwCodecWhitelisted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasWhitelistedRateController())
...
TEST(SoftwareFallbackEncoderTest, SwCodecWhitelistedNoHw) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(true));
  ...
  EXPECT_TRUE(wrapper->HasWhitelistedRateController());
}

TEST(SoftwareFallbackEncoderTest, HwCodecWhitelisted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(false));
...
TEST(SoftwareFallbackEncoderTest, HwCodecWhitelistedNoSw) {
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*hw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(true));
...
TEST(SoftwareFallbackEncoderTest, BothCodecsWhitelisted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasWhitelistedRateController())
      .WillRepeatedly(Return(true));
