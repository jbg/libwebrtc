...
TEST(SoftwareFallbackEncoderTest, BothCodecsNotTrusted) {
...
TEST(SoftwareFallbackEncoderTest, SwCodecTrusted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasTrustedRateController())
...
TEST(SoftwareFallbackEncoderTest, SwCodecTrustedNoHw) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasTrustedRateController())
      .WillRepeatedly(Return(true));
...
TEST(SoftwareFallbackEncoderTest, HwCodecTrusted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasTrustedRateController())
      .WillRepeatedly(Return(false));
...
TEST(SoftwareFallbackEncoderTest, HwCodecTrustedNoSw) {
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*hw_encoder, HasTrustedRateController())
      .WillRepeatedly(Return(true));
...
TEST(SoftwareFallbackEncoderTest, BothCodecsTrusted) {
  auto* sw_encoder = new testing::NiceMock<MockVideoEncoder>();
  auto* hw_encoder = new testing::NiceMock<MockVideoEncoder>();
  EXPECT_CALL(*sw_encoder, HasTrustedRateController())
      .WillRepeatedly(Return(true));
