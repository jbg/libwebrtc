...
class VideoEncoderSoftwareFallbackWrapper final : public VideoEncoder {
 ...
 private:
  ...
  const bool whitelist_rate_controller_;
};
...
VideoEncoderSoftwareFallbackWrapper::VideoEncoderSoftwareFallbackWrapper(
    ...
    : number_of_cores_(0),
      ...
      whitelist_rate_controller_(
          (encoder_ ? encoder_->HasWhitelistedRateController() : true) &&
          (fallback_encoder_ ? fallback_encoder_->HasWhitelistedRateController()
                             : true)) {
...
bool VideoEncoderSoftwareFallbackWrapper::HasWhitelistedRateController() const {
  return whitelist_rate_controller_;
}
