...
// TODO: !!!
class Vp8FrameBufferControllerTemporalLayerBased
    : public Vp8FrameBufferController {
 public:
  ~Vp8FrameBufferControllerTemporalLayerBased() override = default;
};

// This interface defines a way of getting the encoder settings needed to
// realize a temporal layer structure.
class Vp8TemporalLayers /* TODO: !!! final*/ : public Vp8FrameBufferController {
 public:
