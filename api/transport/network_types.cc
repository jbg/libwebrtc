...
webrtc_impl::PacedPacketInfo::PacedPacketInfo() = default;

webrtc_impl::PacedPacketInfo::PacedPacketInfo(int probe_cluster_id,
...
bool webrtc_impl::PacedPacketInfo::operator==(
    const webrtc_impl::PacedPacketInfo& rhs) const {
