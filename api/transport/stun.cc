...
const int k128Utf8Characters = 508;
...
bool LengthValid(int type, int length) {
  ...
  switch (type) {
    case STUN_ATTR_USERNAME:
      return length <= k128Utf8Characters;  // RFC 8489 section 14.3
    case STUN_ATTR_MESSAGE_INTEGRITY:
      return length ==
             kMessageIntegrityAttributeLength;  // RFC 8489 section 14.5
    case STUN_ATTR_REALM:
      return length <= k128Utf8Characters;  // RFC 8489 section 14.9
    case STUN_ATTR_NONCE:
      return length <= k128Utf8Characters;  // RFC 8489 section 14.10
    case STUN_ATTR_SOFTWARE:
      return length <= k128Utf8Characters;  // RFC 8489 section 14.14
