...
#ifndef API_TRANSPORT_RETRANSMISSION_CONTROLLER_INTERFACE_H_
#define API_TRANSPORT_RETRANSMISSION_CONTROLLER_INTERFACE_H_
...
#endif  // API_TRANSPORT_RETRANSMISSION_CONTROLLER_INTERFACE_H_
