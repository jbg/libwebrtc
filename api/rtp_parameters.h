...
struct RTC_EXPORT RtpExtension {
  ...
  static const RtpExtension* FindHeaderExtensionByUri(
      ...
      Filter filter);
  [
      [deprecated("Use RtpExtension::FindHeaderExtensionByUri with filter "
                  "argument")]] static const RtpExtension*
  FindHeaderExtensionByUri(const std::vector<RtpExtension>& extensions,
                           absl::string_view uri);
