...
@implementation ARDSampleHandler {
...
- (void)appClient:(ARDAppClient *)client
    didCreateLocalBroadcastCapturer:(ARDBroadcastCapturer *)broadcastCapturer {
  self.capturer = broadcastCapturer;
}
