...
- (void)parseStatsReport:(WebRTCLegacyStatsReport *)statsReport {
...
- (void)parseBweStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  [statsReport.values
...
- (void)parseConnectionStatsReport:(WebRTCLegacyStatsReport *)statsReport {
...
- (void)parseSendSsrcStatsReport:(WebRTCLegacyStatsReport *)statsReport {
...
- (void)parseAudioSendStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  [statsReport.values
      enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL *stop) {
...
- (void)parseVideoSendStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  [statsReport.values
      enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL *stop) {
...
- (void)parseRecvSsrcStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  NSDictionary *values = statsReport.values;
...
- (void)parseAudioRecvStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  [statsReport.values
      enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL *stop) {
...
- (void)parseVideoRecvStatsReport:(WebRTCLegacyStatsReport *)statsReport {
  [statsReport.values
      enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL *stop) {
