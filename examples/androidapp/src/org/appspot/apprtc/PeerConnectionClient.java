...
public class PeerConnectionClient {
  ...
  public static class PeerConnectionParameters {
    ...
    public final boolean recInputAudioToFile;
    ...
    public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
        ...
        String audioCodec, boolean noAudioProcessing, boolean aecDump, boolean recInputAudioToFile,
      ...
      this(videoCallEnabled, loopback, tracing, videoWidth, videoHeight, videoFps, videoMaxBitrate,
          ...
          noAudioProcessing, aecDump, recInputAudioToFile, useOpenSLES, disableBuiltInAEC,
    ...
    public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
      ...
      this.recInputAudioToFile = recInputAudioToFile;
  ...
  private void createPeerConnectionInternal() {
    ...
    Log.d(TAG, "recInputAudioToFile: " + peerConnectionParameters.recInputAudioToFile);
