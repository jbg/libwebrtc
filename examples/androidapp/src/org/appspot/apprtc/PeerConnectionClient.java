...
public class PeerConnectionClient {
  ...
  private WebRTCAudioRecordSamplesReadyCallback audioRecordSamplesReadyCallback = null;
  ...
  private void createPeerConnectionFactoryInternal() {
    ...
    if (peerConnectionParameters.saveInputAudioToFile) {
      if (isExternalStorageWritable()) {
        ...
        Log.e(TAG, "Unable to record audio on external media");
      }
    }
  ...
  private void closeInternal() {
    ...
    if (rawAudioFileOutputStream != null) {
      ...
      try {
        ...
        reportError("Failed to close file with saved input audio: " + e);
      }
      rawAudioFileOutputStream = null;
    }
    audioRecordSamplesReadyCallback = null;
    localRender = null;
    remoteRenders = null;
