...
public class SettingsActivity extends Activity implements OnSharedPreferenceChangeListener {
  ...
  private String keyprefEnableRecInputAudioToFile;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    keyprefEnableRecInputAudioToFile = getString(R.string.pref_enable_rec_input_audio_to_file_key);
  ...
  protected void onResume() {
    ...
    updateSummaryB(sharedPreferences, keyprefEnableRecInputAudioToFile);
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    ...
    if (key.equals(keyprefResolution)
      ...
      updateSummaryBitrate(sharedPreferences, key);
        ...
        || key.equals(keyprefEnableRecInputAudioToFile)
