...
vars = {
  ...
  'chromium_revision': 'f5fbedab52bc0accbc0edb8878c3f85224c856e3',
...
deps = {
  ...
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + '90ceaf5e3f1d2092689f5ad5fb0123b1f6174208',
  'src/build':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'd1964c80dd084ff5522ff386a714c690142b3bea',
