...
vars = {
  ...
  'chromium_revision': 'd617b2faad73e49eede9b9e5b8d341153f865e0d',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'ac0049a3ac26048681297dc8b29713134c907c88',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '98d73d14e2468871a01d11fd2ce647fa7e1550e9',
  'src/tools/gyp':
