...
vars = {
  ...
  'chromium_revision': '54cef0b8e45c23e90fa4cce0ec6b686a7c5fda98',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '08fa9084219395b2ebf40d02e591202be214906c',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '08eebee412049e700b89677206108f822a13cd25',
  'src/tools/gyp':
