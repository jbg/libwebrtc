...
vars = {
  ...
  'chromium_revision': '86f2d7030bf3378c68be624b614c3b021ce20009',
...
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + '0b61d709ec0dd692b828f1cd5d5568443569bae4',
  'src/buildtools':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '7f5a8863610f65e93cfc8caabfa15231d1590875',
