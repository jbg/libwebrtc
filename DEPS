...
vars = {
  ...
  'chromium_revision': '390e71c24a104276badb586b724f9bcb55a8af11',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '3f8a75a9cb247565a95ec25f40f92989082bed2d',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c312db01688088547f7c2ff405ff3ced145930b9',
  'src/tools/gyp':
