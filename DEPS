...
vars = {
  ...
  'chromium_revision': '756855f3a723451b44219d20b4e1b4f3f83ed7e8',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '1b1d4d2c5d21d417d87effdfbf52b416b8deceba',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'ce7b6840c03de62b5f6fcfcb23f4c6a5437eacba',
  'src/tools/gyp':
