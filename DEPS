...
vars = {
  ...
  'chromium_revision': 'b49091acb37017083a2a3b8332a76c2e06087d90',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '47363127d5667612cc7610eacec536d1b0dcc69e',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '983d6cfc85ce9c47f75e9b48995650340a5f2c70',
  'src/tools/gyp':
