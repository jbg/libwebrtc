...
vars = {
  ...
  'chromium_revision': '8ba7b05a3d35d348293ad22ceeb2a87426b015b7',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'dad38ce33caf4d9a32c78ecafb063c16fc0c4484',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '3b00f4dc4245e9c70388830daaa51d32cd908958',
  'src/tools/gyp':
