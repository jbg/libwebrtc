...
vars = {
  ...
  'chromium_revision': 'dd8fede07314ec38cc940d71bbb9cd691fa16815',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '5825bb9645b2928042efbd9affb3c6a33419d7c2',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '8d202e29b7b04a2ed6ff5e31f08fab84ff497487',
  'src/tools/gyp':
