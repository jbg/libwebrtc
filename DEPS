...
vars = {
  ...
  'chromium_revision': '101c128948eead8b279090a07803dc854d5ff542',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '56c3de6c2b1363ee130913a099a73d4731a9d1a5',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'ebbaf63511921fb8cb25404cf05aee0258895c8f',
  'src/tools/gyp':
