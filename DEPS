...
vars = {
  ...
  'chromium_revision': 'e775eff6c79c3ea8bd117db406ede922e23a291c',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'fd811002bf5ca4076049894939aa7730fa2b3400',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c8e6b2302740201ff5c4a8b8ac49bd9bc028a3d8',
  'src/tools/gyp':
