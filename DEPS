...
vars = {
  ...
  'chromium_revision': 'c2c7bcf2ac602f35f06bce254e4f94549eba3f63',
...
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '77ee88ee587cebda8805303050dc60ff86b75e91',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '12451ffa9babfec3bf53ff36040065ecde152536',
