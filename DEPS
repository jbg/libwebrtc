...
vars = {
  ...
  'chromium_revision': '22d5a89624ac38f9803a705a98972480d0217c34',
}
...
deps = {
  ...
  'src/build':
    'https://chromium.googlesource.com/chromium/src/build@2ae82a124e9ffc555ef0244c129e7f3f34ffda0c',
  'src/buildtools':
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@a1ad513ac64f1dce007c8eabbb17ecf382d7e3c9',
      ...
      'packages': [
        {
          ...
          'version': 'git_revision:b1ba7603f4b71ab63a1df050e03137463309f348',
        },
        {
