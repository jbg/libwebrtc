...
vars = {
  ...
  'chromium_revision': '56917206dc32bd55747896c3fb3ea0ecf480b946',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'ae856ddec791813560a05b4d01a1c25b3bddd8a4',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '9e632ed4057de557155b10537a6ba4498bb9b7af',
  'src/tools/gyp':
