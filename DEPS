...
vars = {
  ...
  'chromium_revision': '66e09f570b282c89372a7d406de82aebab6a36ca',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '265a7d6cfca5de45da4fb370c3602b7aaea98234',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '380d8ff6666204fee95903ae04596831e851c237',
  'src/tools/gyp':
