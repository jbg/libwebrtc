...
vars = {
  ...
  'chromium_revision': '40246e39f5e26e52ede41329042cf60671a19961',
...
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + 'c758d63d338b18086d43f5441657b2304a3366b0',
  'src/buildtools':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '90e1a51706a35fa6743a022831f07681bf46a3be',
