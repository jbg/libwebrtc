...
vars = {
  ...
  'chromium_revision': 'beefaef17dbff57620f44b59c14178c7c7f84be4',
...
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '30b372f84a36462119360dd85f8cebaa1184c193',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '7d2706a39eec812f65b5aaec1351a6bfe911a596',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '24f88b679af3bcede40cdd2c156fab0127baf2a4',
  'src/tools/gyp':
