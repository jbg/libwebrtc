...
vars = {
  ...
  'chromium_revision': 'ec25b51043b153b0b79fa7a0ff28b069e71e498f',
...
deps = {
  ...
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + '36a754ffe134e44c54e3a968b01f0dbd8523793d',
  'src/build':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '3da93082b2005da6cdcef062d13d8314b239cfc8',
