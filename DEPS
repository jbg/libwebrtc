...
vars = {
  ...
  'chromium_revision': '7ebede76882fac9b113e5e272dbada9f5da423fd',
...
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + '6abdef0e8603746558940776c63cbd4dec982e4f',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '8cff277c62d8ea3a38c06075a9ffa5e6b8c8acd8',
  'src/tools/gyp':
