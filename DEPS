...
vars = {
  ...
  'chromium_revision': '8c17f12a9b58f74c8d4213942d5b232248052aca',
...
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + 'ef1a12a698dc61a57373fe2bf912e0986fc7aece',
    'condition': 'checkout_ios',
  },
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '428bebc5c79e1be2b073cad550e585fbc5025950',
  'src/third_party':
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '0f05d836222d453e5833984bb3779497e9cd4d48',
