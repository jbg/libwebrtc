...
vars = {
  ...
  'chromium_revision': 'd42019b17546ac18febf6b08e38922819c1e2af5',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '94365ac6b8da8db19bb53454af01e31fc3cab8b1',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '80b616493254bcbf2c85c4459e8b47d5332cece2',
  'src/tools/gyp':
