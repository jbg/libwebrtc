...
vars = {
  ...
  'chromium_revision': '92ff5ccfaf16d5e5b662be28e5d655ddccef921e',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '753026065d189e0a7704ceede603f6981790c3d2',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'e8a773fdb025b1ee07aa2158c7ab149717438971',
  'src/tools/gyp':
