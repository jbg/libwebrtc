...
vars = {
  ...
  'chromium_revision': '11044116cd340886995030730ca6916a8cf1d471',
}
...
deps = {
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@937993160c418c1eaa65a269669ca216b1cf1a0d',
