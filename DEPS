...
vars = {
  ...
  'chromium_revision': 'bc007d403e15f4fdce226c0495a8735770feda49',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'd91cb3cfbac4b319e409dfbf2db95f0e961a46ec',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '0f1d342c45193e3d457d76eb711cddb38f96022e',
