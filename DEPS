...
vars = {
  ...
  # Not roll chromium into webrtc by default. This can be disabled e.g. with custom_vars.
  ...
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Chrome third_party
  # and whatever else without interference from each other.
  'chrome_third_party_revision': '4e16929f465a47942875a80da0140bfaa59e99fb',
}
deps = {
  ...
  'src/third_party_chromium': {
      'url': Var('chromium_git') + '/chromium/src/third_party' + '@' + Var('chrome_third_party_revision'),
