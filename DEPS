...
vars = {
  ...
  'chromium_revision': 'ab7776ffcbfbf44cd4b6c2bf1ecf0adceb91207b',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '243dbcd785c7c84e219c80b3aafbc7f846b2c168',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'f45371703a0ff74a9a8573992e2730def320da30',
  'src/tools/gyp':
