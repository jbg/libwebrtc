...
vars = {
  ...
  'chromium_revision': 'c47cdd2f57bd2339cafab8606bce0f582580b434',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '0029c4b60fafab02ef302027ceb0dfe8b22fa999',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '375d163cce2617e2c8e80199b9dcdfd2458059ce',
