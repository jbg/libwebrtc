...
vars = {
  ...
  'chromium_revision': '8d0e11cc9ffb098fd0f4405b95807cc67965fd64',
...
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + '0183cc5da2483e4ab39947c494d84c4bfda42135',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '4faf3e4a1366a6eee52f312d65732ac4f6855fbe',
  'src/tools/gyp':
