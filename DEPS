...
vars = {
  ...
  'chromium_revision': '7a905f71a80073671a2a2aee602dd893cde554cd',
}
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@b4855111f81ee083c7736da23aa747591a65ab6d',
