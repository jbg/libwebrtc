...
vars = {
  ...
  'chromium_revision': '75ba586fefe1b38d7452246ebb8b5cb264c9c391',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'b6a48de5df159ff5d1e839b31d546a77e2a176e2',
}
deps = {
  # TODO(kjellander): Move this to be Android-only once the libevent dependency
  # in base/third_party/libevent is solved.
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + 'bc546c2767ec32f881df5a05353967d741e1a743',
  'src/build':
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '5820178ecd064c07f2b7fc2d108b0112c7ff9275',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'e621eb2b036d298a9fb02489dfbc4ae2219a2406',
  'src/tools/gyp':
