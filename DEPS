...
vars = {
  ...
  'chromium_revision': 'aad06d1d33423d7fed0560c47f8381cdff1bd63d',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '4863fbc52abb8cff08d033ffbcde27f2201cfd44',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '69469f2432027cf0ebbd985e4c1f705019e0a1eb',
