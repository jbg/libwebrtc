...
vars = {
  ...
  'chromium_revision': '9df70adfe304a4da739eba031911cac3c7b0dc24',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '062d51d4c5a155b0c85ca954f7031b53da350d4d',
}
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + '5126ff23eeea95f9685fcc9685621bef5a8fcc23',
  'src/buildtools':
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '9318ba455f846661841d090ffb192ebdf1df0ae5',
  'src/tools/gyp':
