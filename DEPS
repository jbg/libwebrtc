...
vars = {
  ...
  'chromium_revision': '2eceba98b54cbff095f44e7f3c83d0ef594e16db',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '753b9128dfc725718d7efd04f6313dd45ad31176',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c62bf017577a41e56943b3a1c650179910accbc6',
  'src/tools/gyp':
