...
vars = {
  ...
  'chromium_revision': '45ce80a820a617b25572826b10390ae678fce113',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '4c0e1a854445b140236cd8563e08b7260862bebf',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'eb4fa346946fb86b23b74abcaa72d699682659b3',
  'src/tools/gyp':
