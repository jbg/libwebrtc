...
vars = {
  ...
  'chromium_revision': 'eacd48f8498212b43d7cefee9acaf38bae16ef6a',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '2a7a89125e6bfe6459ca9d2b95f827364fc88c7b',
}
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + 'add9400c5809c4775a2e60db5a9e8faa47cbfca7',
    'condition': 'checkout_ios',
  },
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + 'a81ae23f70962b9dd9d0da668038b5a743f7a7ed',
  ...
  'src/third_party/winsdk_samples': {
    'url': Var('webrtc_git') + '/deps/third_party/winsdk_samples_v71' + '@' + '6e8a05d4d6909c684bcf05114ab6d27ffdf846fa',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'f3bbc9730ea6cdb10bafad58a15c1b00915d9dd0',
  'src/tools/gyp':
