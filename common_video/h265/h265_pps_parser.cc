...
absl::optional<H265PpsParser::PpsState> H265PpsParser::ParseInternal(
  ...
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadBits(&pps.dependent_slice_segments_enabled_flag, 1));
  // output_flag_present_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(&pps.output_flag_present_flag, 1));
  // num_extra_slice_header_bits: u(3)
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadBits(&pps.num_extra_slice_header_bits, 3));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadExponentialGolomb(
  ...
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadSignedExponentialGolomb(&signed_golomb_ignored));
  ...
  if (tiles_enabled_flag) {
    ...
    RETURN_EMPTY_ON_FAIL(
        bit_buffer->ReadExponentialGolomb(&num_tile_columns_minus1));
    // num_tile_rows_minus1: ue(v)
    uint32_t num_tile_rows_minus1 = 0;
    RETURN_EMPTY_ON_FAIL(
        bit_buffer->ReadExponentialGolomb(&num_tile_rows_minus1));
  ...
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadBits(&deblocking_filter_control_present_flag, 1));
  if (deblocking_filter_control_present_flag) {
    ...
    RETURN_EMPTY_ON_FAIL(
        bit_buffer->ReadBits(&pps_deblocking_filter_disabled_flag, 1));
  ...
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadBits(&pps_scaling_list_data_present_flag, 1));
  ...
  RETURN_EMPTY_ON_FAIL(
      bit_buffer->ReadBits(&pps.lists_modification_present_flag, 1));
