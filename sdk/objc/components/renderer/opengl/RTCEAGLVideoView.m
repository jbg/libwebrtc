...
// WebRTCEAGLVideoView wraps a GLKView which is setup with
...
// is disabled for the reasons above, the WebRTCEAGLVideoView maintains
// its own |isDirty| flag.

@interface WebRTCEAGLVideoView () <GLKViewDelegate>
...
@implementation WebRTCEAGLVideoView {
...
- (instancetype)initWithFrame:(CGRect)frame shader:(id<WebRTCVideoViewShading>)shader {
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder shader:(id<WebRTCVideoViewShading>)shader {
...
- (BOOL)configure {
  ...
  __weak WebRTCEAGLVideoView *weakSelf = self;
  _timer = [[RTCDisplayLinkTimer alloc] initWithTimerHandler:^{
      WebRTCEAGLVideoView *strongSelf = weakSelf;
