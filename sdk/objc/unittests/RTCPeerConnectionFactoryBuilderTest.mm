...
- (void)testBuilder {
  id factoryMock = OCMStrictClassMock([WebRTCPeerConnectionFactory class]);
  ...
  WebRTCPeerConnectionFactory* peerConnectionFactory = [builder createPeerConnectionFactory];
