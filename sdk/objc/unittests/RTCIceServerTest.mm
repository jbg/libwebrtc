...
- (void)testOneURLServer {
  WebRTCIceServer *server = [[WebRTCIceServer alloc] initWithURLStrings:@[
...
- (void)testPasswordCredential {
  WebRTCIceServer *server = [[WebRTCIceServer alloc]
...
- (void)testHostname {
  WebRTCIceServer *server = [[WebRTCIceServer alloc] initWithURLStrings:@[ @"turn1:turn1.example.net" ]
                                                         username:@"username"
                                                       credential:@"credential"
...
- (void)testInitFromNativeServer {
  ...
  WebRTCIceServer *iceServer =
      [[WebRTCIceServer alloc] initWithNativeServer:nativeServer];
