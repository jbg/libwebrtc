...
- (webrtc::PeerConnectionInterface::SSLConfig)nativeConfig {
  ...
  switch (_tlsCertPolicy) {
    case RTCTlsCertPolicySecure:
      sslConfig.tls_cert_policy = webrtc::PeerConnectionInterface::kTlsCertPolicySecure;
      break;
    case RTCTlsCertPolicyInsecureNoCheck:
      sslConfig.tls_cert_policy = webrtc::PeerConnectionInterface::kTlsCertPolicyInsecureNoCheck;
      break;
  }
