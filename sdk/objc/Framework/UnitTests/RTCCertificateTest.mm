...
// TMP: Renamed test case RTCCertificateTestObjC as workaround to error:
// "All tests in the same test case must use the same test fixture class"
TEST(RTCCertificateTestObjC, CertificateIsUsedInConfigTest) {
