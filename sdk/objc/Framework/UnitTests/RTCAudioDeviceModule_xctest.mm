...
static const NSTimeInterval kTestTimeOutInSec = 10.0;
...
static const NSUInteger kFullDuplexTimeInSec = 15;
...
- (void)testRunPlayoutAndRecordingInFullDuplex {
  ...
  [self startRecording];
  [self startPlayout];
  [self waitForExpectationsWithTimeout:kFullDuplexTimeInSec handler:nil];
