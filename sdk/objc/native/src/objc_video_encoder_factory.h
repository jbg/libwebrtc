...
class ObjCVideoEncoderFactory : public VideoEncoderFactory {
 public:
  explicit ObjCVideoEncoderFactory(id<WebRTCVideoEncoderFactory>);
  ~ObjCVideoEncoderFactory() override;

  id<WebRTCVideoEncoderFactory> wrapped_encoder_factory() const;
 ...
 private:
  id<WebRTCVideoEncoderFactory> encoder_factory_;
};
