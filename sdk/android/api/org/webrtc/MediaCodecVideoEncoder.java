...
public class MediaCodecVideoEncoder {
  ...
  @VideoCodecType private int videoCodecType;
  ...
  boolean initEncode(@VideoCodecType int videoCodecType, int profile, int width, int height,
      int kbps, int fps, boolean useSurface) {
    Logging.d(TAG,
  ...
  OutputBufferInfo dequeueOutputBuffer() {
    ...
    try {
      ...
      if (result >= 0) {
        ...
        if (isKeyFrame && videoCodecType == VideoCodecType.H264) {
