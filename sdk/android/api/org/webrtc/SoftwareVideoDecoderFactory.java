...
public class SoftwareVideoDecoderFactory implements VideoDecoderFactory {
  ...
  public VideoDecoder createDecoder(VideoCodecInfo codecInfo) {
    if (codecInfo.getName().equalsIgnoreCase(VideoCodecMimeType.VP8.toSdpCodecName())) {
      return new LibvpxVp8Decoder();
    }
    if (codecInfo.getName().equalsIgnoreCase(VideoCodecMimeType.VP9.toSdpCodecName())
        && LibvpxVp9Decoder.nativeIsSupported()) {
      return new LibvpxVp9Decoder();
    }
    if (codecInfo.getName().equalsIgnoreCase(VideoCodecMimeType.AV1.toSdpCodecName())
