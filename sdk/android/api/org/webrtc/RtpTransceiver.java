...
public class RtpTransceiver {
  ...
  public static final class RtpTransceiverInit {
    ...
    public RtpTransceiverInit(RtpTransceiverDirection direction) {
      ...
      this.streamLabels = new ArrayList<String>();
      this.sendEncodings = new ArrayList<Encoding>();
    }
    ...
    @CalledByNative("RtpTransceiverInit")
    List<String> getStreamLabels() {
      return new ArrayList<String>(this.streamLabels);
    }
