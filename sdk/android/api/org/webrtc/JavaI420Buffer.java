...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
  ...
  public static JavaI420Buffer wrap(int width, int height, ByteBuffer dataY, int strideY,
    ...
    if (dataU.capacity() < minCapacityU) {
      throw new IllegalArgumentException("U-buffer of size "+ dataU.capacity() + " must be at least " + minCapacityU + " bytes.");
    }
  ...
  public VideoFrame.Buffer spawnMask(){
    ...
    return new JavaI420Buffer(width, height,dataA,strideA,dataU,strideU,dataV,strideV,null,0,null);
  }
}
