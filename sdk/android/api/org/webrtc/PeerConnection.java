...
public class PeerConnection {
   ...
   *
   *  Errors: If an error occurs in C++, returns null. An error can occur if:
   ...
   *
   *  These methods are only available with SdpSemantics.UNIFIED_PLAN specified.
   */
  ...
  // Adds a transceiver with a media type. Can either be MEDIA_TYPE_AUDIO or MEDIA_TYPE_VIDEO.
