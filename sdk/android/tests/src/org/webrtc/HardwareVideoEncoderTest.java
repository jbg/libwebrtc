...
public class HardwareVideoEncoderTest {
  ...
  private void encodeWithConfigBuffer(
      VideoCodecMimeType codecType, boolean keyFrame, boolean emptyConfig, String expected) {
  ...
  @Test
  public void encode_vp8KeyFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(VP8, /*keyFrame=*/true, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_vp9KeyFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(VP9, /*keyFrame=*/true, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_av1KeyFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(AV1, /*keyFrame=*/true, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_h264KeyFrame_nonEmptyConfig_configPrepended() {
    encodeWithConfigBuffer(H264, /*keyFrame=*/true, /* emptyConfig= */ false, "configframe");
  }

  @Test
  public void encode_h265KeyFrame_nonEmptyConfig_configPrepended() {
    encodeWithConfigBuffer(H265, /*keyFrame=*/true, /* emptyConfig= */ false, "configframe");
  }

  @Test
  public void encode_vp8DeltaFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(VP8, /*keyFrame=*/false, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_vp9DeltaFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(VP9, /*keyFrame=*/false, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_av1DeltaFrame_nonEmptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(AV1, /*keyFrame=*/false, /* emptyConfig= */ false, "frame");
  }

  @Test
  public void encode_h264KeyFrame_emptyConfig_configNotPrepended() {
    encodeWithConfigBuffer(H264, /*keyFrame=*/true, /* emptyConfig= */ true, "frame");
  }

  @Test
  public void encode_h265KeyFrame_emptyConfig_configNotPrepended() {
