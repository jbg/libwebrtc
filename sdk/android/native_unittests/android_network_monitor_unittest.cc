...
// The first 64 bits of the following two ipv6 addresses are the same.
...
class AndroidNetworkMonitorTest : public ::testing::Test {
 public:
  AndroidNetworkMonitorTest() {
    ...
    network_monitor_.reset(new jni::AndroidNetworkMonitor(env, context));
  }
