...
class TextureBufferImpl implements VideoFrame.TextureBuffer {
  ...
  public TextureBufferImpl(int width, int height, Type type, int id, Matrix transformMatrix,
                           ...
                           int mask_texture_id, int mask_width, int mask_height,
  ...
  public VideoFrame.Buffer cropAndScale(
    ...
    return new TextureBufferImpl(scaleWidth, scaleHeight, type, id, newMatrix, surfaceTextureHelper,
            mask_texture_id, mask_width, mask_height, new Runnable() {
      @Override
      public void run() {
        release();
      }
  ...
  public VideoFrame.Buffer spawnMask() {
    ...
    mask_texture_id = -1;
    return new TextureBufferImpl(width, height, Type.RGB, mask_id, transformMatrix, surfaceTextureHelper,
            -1, 0, 0, new Runnable() {
      @Override
      public void run() {
        release();
