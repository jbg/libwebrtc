...
#ifndef SDK_ANDROID_SRC_JNI_SSLCERTIFICATEVERIFIERWRAPPER_H_
#define SDK_ANDROID_SRC_JNI_SSLCERTIFICATEVERIFIERWRAPPER_H_
...
#endif  // SDK_ANDROID_SRC_JNI_SSLCERTIFICATEVERIFIERWRAPPER_H_
