...
void AndroidNetworkMonitor::OnNetworkDisconnected_n(NetworkHandle handle) {
  ...
  // name. 2) OnNetworkDisconnected_n, we scan and see if there are any
  // connected networks with the interface name, and set them as owner.
...
void AndroidNetworkMonitor::SetNetworkInfos(
  ...
  RTC_CHECK(network_handle_by_if_name_.empty());
