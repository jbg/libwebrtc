...
// #include "sdk/android/generated_external_classes_jni/jni/Entry_jni.h"
...
std::map<std::string, std::string> JavaToStdMapStrings(JNIEnv* jni,
  ...
  jclass entry_class = GetObjectClass(jni, j_entry_set);
...
jobject JavaListBuilder::GetJavaList() {
  return j_list_;
}
