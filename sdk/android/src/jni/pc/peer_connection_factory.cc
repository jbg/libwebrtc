...
ScopedJavaLocalRef<jobject> CreatePeerConnectionFactoryForJava(
    ...
    std::unique_ptr<NetworkPredictorFactoryInterface> network_predictor_factory,
  ...
  dependencies.network_predictor_factory = std::move(network_predictor_factory);
...
JNI_PeerConnectionFactory_CreatePeerConnectionFactory(
    ...
    jlong native_network_predictor_factory,
  ...
  return CreatePeerConnectionFactoryForJava(
      ...
      TakeOwnershipOfUniquePtr<NetworkPredictorFactoryInterface>(
          native_network_predictor_factory),
