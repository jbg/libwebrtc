...
#include "sdk/android/generated_audio_codecs_jni/jni/BuiltinAudioEncoderFactoryFactory_jni.h"
...
static jlong
JNI_BuiltinAudioDecoderFactoryFactory_CreateBuiltinAudioEncoderFactory(
    JNIEnv* env,
