...
struct ConfigHelper {
  ...
  std::unique_ptr<internal::AudioSendStream> CreateAudioSendStream() {
    return std::unique_ptr<internal::AudioSendStream>(
        new internal::AudioSendStream(
            ...
            &active_lifetime_,
            std::unique_ptr<voe::ChannelSendInterface>(channel_proxy_)));
  }
  ...
  MockChannelSend* channel_proxy() { return channel_proxy_; }
  ...
  void SetupDefaultChannelProxy(bool audio_bwe_enabled) {
    ...
    channel_proxy_ = new testing::StrictMock<MockChannelSend>();
 ...
 private:
  ...
  testing::StrictMock<MockChannelSend>* channel_proxy_ = nullptr;
