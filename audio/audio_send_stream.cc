...
uint32_t AudioSendStream::OnBitrateUpdated(BitrateAllocationUpdate update) {
  auto constraints = GetMinMaxBitrateWithOverhead(GetPerPacketOverheadBytes());
...
AudioSendStream::GetMinMaxBitrateWithOverhead(
...
void AudioSendStream::ConfigureBitrateObserver() {
  ...
  worker_queue_->PostTask([&] {
    ...
    // as well.
    auto constraints =
        GetMinMaxBitrateWithOverhead(configured_overhead_per_packet_bytes_);
