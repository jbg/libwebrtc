...
void AudioSendStream::Start() {
  ...
  if (allocation_settings_.IncludeAudioInAllocationOnStart(
    ...
    rtp_transport_->AcccountForAudioPacketsInPacedSender(true);
...
void AudioSendStream::ReconfigureBitrateObserver(
  ...
  if (stream->allocation_settings_.IncludeAudioInAllocationOnReconfigure(
    ...
    stream->rtp_transport_->AcccountForAudioPacketsInPacedSender(true);
    rtc::Event thread_sync_event;
    ...
    stream->rtp_transport_->AcccountForAudioPacketsInPacedSender(false);
