...
void ChannelSend::SetRTCP_CNAME(absl::string_view c_name) {
  ...
  absl::string_view c_name_limited = c_name.substr(0, 255);
  std::string c_name_copy(c_name_limited.data(), c_name_limited.length());
  if (_rtpRtcpModule->SetCNAME(c_name_copy.c_str()) != 0) {
