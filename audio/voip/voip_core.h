...
class VoipCore : public VoipEngine,
 ...
 public:
  ...
  void GetDecodingStatistics(ChannelId channel,
                             DecodingStatistics& decoding_stats) override;
  void GetNetEqStatistics(ChannelId channel,
                          NetEqStatistics& neteq_stats) override;
