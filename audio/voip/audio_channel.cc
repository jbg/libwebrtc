...
void AudioChannel::GetDecodingStatistics(DecodingStatistics& decoding_stats) {
...
void AudioChannel::GetNetEqStatistics(NetEqStatistics& neteq_stats) {
  ...
  neteq_stats.packet_buffer_flushes = stats.packetBufferFlushes;
}
