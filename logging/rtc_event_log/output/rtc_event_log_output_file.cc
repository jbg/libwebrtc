...
RtcEventLogOutputFile::RtcEventLogOutputFile(const std::string& file_name,
    ...
    // Unlike plain fopen, OpenPlatformFile takes care of utf8 ->
    // wchar conversion on windows.
    : RtcEventLogOutputFile(rtc::OpenPlatformFile(file_name), max_size_bytes) {}
...
RtcEventLogOutputFile::RtcEventLogOutputFile(rtc::PlatformFile platform_file,
  ...
  // Handle errors from the OpenPlatformFile call in above constructor.
