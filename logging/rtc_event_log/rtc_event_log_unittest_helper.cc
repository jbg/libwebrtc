...
void VerifyLoggedRtpPacketIncoming(
  ...
  size_t original_packet_length = original_event.payload_length_ +
                                  original_event.header_length_ +
                                  original_event.padding_length_;
  EXPECT_EQ(original_packet_length, logged_event.rtp.total_length);
