...
#if defined(WEBRTC_IOS)
#define MAYBE_TestFiniteResultError DISABLED_TestFiniteResultError
#else
#define MAYBE_TestFiniteResultError TestFiniteResultError
#endif
TEST_F(PerfTest, MAYBE_TestFiniteResultError) {
