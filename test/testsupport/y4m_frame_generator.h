...
// Generates frames from a Y4M file in a Ping Pong fashion (when reaching EOF,
// it generates frames backwards until it reaches the beginning of the file, at
// that point it switches to generate frames going forward, etc..).
