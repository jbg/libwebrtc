...
class DEPRECATED_SingleThreadedTaskQueueForTesting : public TaskQueueBase {
 public:
  ...
  // TODO(bugs.webrtc.org/10933): Replace usage of the SendTask function with
  // the free SendTask function to reduce dependencies on this class.
  template <typename Closure>
  void SendTask(Closure&& task) {
    ::webrtc::SendTask(this, std::forward<Closure>(task));
  }
