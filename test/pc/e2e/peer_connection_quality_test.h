...
class PeerConnectionE2EQualityTest
 ...
 public:
  ...
  using StatsReporter = PeerConnectionE2EQualityTestFixture::StatsReporter;
  ...
  void AddStatsReporter(std::unique_ptr<StatsReporter> stats_reporter) override;
 ...
 private:
  ...
  std::vector<std::unique_ptr<StatsReporter>> stats_reporters_;
