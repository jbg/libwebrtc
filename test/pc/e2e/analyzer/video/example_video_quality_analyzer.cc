...
void ExampleVideoQualityAnalyzer::Start(uint16_t threads_count) {}
...
uint64_t ExampleVideoQualityAnalyzer::getFramesCaptured() const {
  return frames_captured_;
}

uint64_t ExampleVideoQualityAnalyzer::getFramesSent() const {
  return frames_sent_;
}

uint64_t ExampleVideoQualityAnalyzer::getFramesReceived() const {
  return frames_received_;
}

uint64_t ExampleVideoQualityAnalyzer::getFramesDropped() const {
  return frames_dropped_;
}

uint64_t ExampleVideoQualityAnalyzer::getFramesRendered() const {
