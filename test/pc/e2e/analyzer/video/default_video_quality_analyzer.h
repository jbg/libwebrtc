 ...
 private:
  ...
  class FrameInFlight {
   public:
    ...
    dvqa_internal::FrameStats GetStatsForPeer(size_t peer) const;
  ...
  void AddComparison(dvqa_internal::InternalStatsKey stats_key,
  ...
  void ProcessComparison(const dvqa_internal::FrameComparison& comparison);
  ...
  Timestamp Now();
  StatsKey ToStatsKey(const dvqa_internal::InternalStatsKey& key) const
      RTC_EXCLUSIVE_LOCKS_REQUIRED(lock_);
  ...
  std::map<dvqa_internal::InternalStatsKey, FrameCounters>
  ...
  std::map<dvqa_internal::InternalStatsKey, StreamStats> stream_stats_
      RTC_GUARDED_BY(comparison_lock_);
  std::map<dvqa_internal::InternalStatsKey, Timestamp>
      stream_last_freeze_end_time_ RTC_GUARDED_BY(comparison_lock_);
  std::deque<dvqa_internal::FrameComparison> comparisons_
      RTC_GUARDED_BY(comparison_lock_);
