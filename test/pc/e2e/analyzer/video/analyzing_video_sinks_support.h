...
#ifndef TEST_PC_E2E_ANALYZER_VIDEO_ANALYZING_VIDEO_SINKS_SUPPORT_H_
#define TEST_PC_E2E_ANALYZER_VIDEO_ANALYZING_VIDEO_SINKS_SUPPORT_H_
...
// Registry of known video configs. This class is thread safe.
class AnalyzingVideoSinksSupport {
 public:
  ...
  // this class will be closed during `AnalyzingVideoSinksSupport` destruction
  // and guaranteed to be alive either until explicitly removed by
  // `CloseAndRemoveVideoWriters` or until `AnalyzingVideoSinksSupport` is
  // destroyed.
  //
  // Returns pointer to the added writer. Ownership is maintained by
  // `AnalyzingVideoSinksSupport`.
...
#endif  // TEST_PC_E2E_ANALYZER_VIDEO_ANALYZING_VIDEO_SINKS_SUPPORT_H_
