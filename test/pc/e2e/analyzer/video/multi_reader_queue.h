...
// from its own queue head. When elements added it will be come visible for all
// readers. When the last reader poped element from the its own head, the
// element will be removed from the queue.
template <typename T>
