 ...
 public:
  ...
  class PeerConfigurer {
   public:
    ...
    // Next objects will be passed to the PeerConnectionFactoryInterface
    // implementation that will be created for this peer.
    ...
    // Next objects will be passed to the PeerConnectionInterface implementation
    // that will be created for this peer.
