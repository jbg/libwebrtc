...
class CrossMediaMetricsReporter
 ...
 public:
  ...
  void Start(absl::string_view test_case_name,
             const TrackIdStreamLabelMap* analyzer_helper) override;
  void OnStatsReports(
 ...
 private:
  ...
  std::string GetTestCaseName(const absl::string_view sync_group_label) const;

  std::string test_case_name_;
  const TrackIdStreamLabelMap* analyzer_helper_;
