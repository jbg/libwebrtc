 ...
 */
#ifndef TEST_PC_E2E_PEERCONNECTION_QUALITY_TEST_H_
#define TEST_PC_E2E_PEERCONNECTION_QUALITY_TEST_H_
...
class PeerConnectionE2EQualityTest
 ...
 private:
  // Sets missed video stream labels to unique generated values. Uniqueness is
  // guaranteed only among generated values, not among generated with provided.
  ...
  void Run_s(RunParams run_params);
  ...
  std::vector<rtc::scoped_refptr<FrameGeneratorCapturerVideoTrackSource>>
      video_sources_;
  std::vector<std::unique_ptr<VideoFrameWriter>> input_dump_video_writers_;
  std::vector<std::unique_ptr<rtc::VideoSinkInterface<VideoFrame>>>
      output_video_sinks_;
  std::vector<std::unique_ptr<VideoFrameWriter>> output_dump_video_writers_;
};

}  // namespace test
}  // namespace webrtc

#endif  // TEST_PC_E2E_PEERCONNECTION_QUALITY_TEST_H_
