...
//   std::map<rtc::IPAddress, std::unique_ptr<EmulatedNetworkOutgoingStats>>
//   out; for (const auto& entry : outgoing_stats_per_destination_) {
//     out.emplace(entry.first,
//     std::make_unique<EmulatedNetworkOutgoingStatsImpl>(
//                                  *entry.second));
//   }
//   return out;
// }
...
//   std::map<rtc::IPAddress, std::unique_ptr<EmulatedNetworkIncomingStats>>
//   out; for (const auto& entry : incoming_stats_per_source_) {
//     out.emplace(entry.first,
//     std::make_unique<EmulatedNetworkIncomingStatsImpl>(
//                                  *entry.second));
//   }
//   return out;
// }
