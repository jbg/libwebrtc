...
class EmulatedNetworkOutgoingStatsImpl final
 ...
 public:
  ...
  SamplesStatsCounter SentPacketsSizeCounter() const override {
...
class EmulatedNetworkIncomingStatsImpl final
 ...
 public:
  ...
  SamplesStatsCounter ReceivedPacketsSizeCounter() const override {
  ...
  SamplesStatsCounter DroppedPacketsSizeCounter() const override {
...
class EmulatedNetworkStatsImpl final : public EmulatedNetworkStats {
 public:
  ...
  SamplesStatsCounter SentPacketsSizeCounter() const override {
    return GetOverallOutgoingStats()->SentPacketsSizeCounter();
  }

  SamplesStatsCounter SentPacketsQueueWaitTimeUs() const override {
  ...
  SamplesStatsCounter ReceivedPacketsSizeCounter() const override {
    return GetOverallIncomingStats()->ReceivedPacketsSizeCounter();
  }
  ...
  SamplesStatsCounter DroppedPacketsSizeCounter() const override {
    return GetOverallIncomingStats()->DroppedPacketsSizeCounter();
  }
...
class EmulatedNetworkIncomingStatsBuilder {
 public:
  ...
  void OnPacketDropped(Timestamp dropped_time,
                       DataSize packet_size,
                       EmulatedEndpointConfig::StatsGatheringMode mode);
