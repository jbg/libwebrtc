...
struct EmulatedNetworkOutgoingStatsStruct {
...
class EmulatedNetworkOutgoingStatsBuilder {
 public:
  ...
  void AppendOutgoingStats(const EmulatedNetworkOutgoingStats& stats);
...
class EmulatedNetworkIncomingStatsBuilder {
 public:
  ...
  void AppendIncomingStats(const EmulatedNetworkIncomingStats& stats);
...
class EmulatedNetworkStatsBuilder {
 public:
  ...
  void AppendEmulatedNetworkStats(const EmulatedNetworkStats& stats);
