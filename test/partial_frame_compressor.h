...
#ifndef TEST_PARTIAL_FRAME_COMPRESSOR_H_
#define TEST_PARTIAL_FRAME_COMPRESSOR_H_
...
class PartialFrameCompressor : public rtc::VideoSinkInterface<VideoFrame>,
                               public rtc::VideoSourceInterface<VideoFrame> {
 public:
  PartialFrameCompressor();
  ~PartialFrameCompressor();
...
#endif  // TEST_PARTIAL_FRAME_COMPRESSOR_H_
