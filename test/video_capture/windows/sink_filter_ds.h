...
#ifndef TEST_VIDEO_CAPTURE_WINDOWS_SINK_FILTER_DS_H_
#define TEST_VIDEO_CAPTURE_WINDOWS_SINK_FILTER_DS_H_
...
#endif  // TEST_VIDEO_CAPTURE_WINDOWS_SINK_FILTER_DS_H_
