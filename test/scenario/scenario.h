...
class Scenario {
 public:
  ...
  SimulatedTimeClient* CreateInstantController(
      std::string name,
 ...
 private:
  ...
  Clock* clock_;
  // Event logs use global clock instange, this is used to override that
  ...
  std::vector<std::unique_ptr<SimulatedTimeClient>> instant_clients_;
