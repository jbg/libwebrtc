...
class RtpTransportAdapter : public RtpTransportInternalAdapter {
 public:
  ...
  rtc::Optional<rtc::CryptoOptions> crypto_options() const override {
    return transport_->crypto_options();
  }

  bool IsSrtpTransport() const { return is_srtp_transport_; }

  bool ReadyToSetupSrtp() const {
    return srtp_send_key_set_ && srtp_recv_key_set_;
  }
 ...
 private:
  ...
  bool srtp_send_key_set_ = false;
  bool srtp_recv_key_set_ = false;
