...
// messages will be discarded, but that may change in the future. RF8831 allows
// both behaviors.
 ...
 private:
  ...
  class CurrentRequest {
   public:
    ...
    // queue. The receiver uses this to know when all data up to this TSN
    // has been received, to know when to safely reset the stream.
