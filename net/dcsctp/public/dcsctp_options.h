...
struct DcSctpOptions {
  ...
  // on how large the exponential backoff timeout can grow. The lower the
  // number, the faster the connection can recover on transient network issues.
  // Changing this value may require changing `max_retransmissions` and
