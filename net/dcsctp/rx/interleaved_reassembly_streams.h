...
// DO NOT SUBMIT: Support `handover_state`
class InterleavedReassemblyStreams : public ReassemblyStreams {
 public:
  ...
  HandoverReadinessStatus GetHandoverReadiness() const override {
    return HandoverReadinessStatus();
  }
 ...
 private:
  ...
  std::map<StreamID, UnorderedStream> unordered_chunks_;
  std::map<StreamID, OrderedStream> ordered_chunks_;
};
