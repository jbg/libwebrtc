...
TEST(FieldTrialMergingTest, MergesValidInput) {
  EXPECT_EQ(MergeFieldTrialStrings("Video/Enabled/", "Audio/Enabled/"),
            "Audio/Enabled/Video/Enabled/");
  EXPECT_EQ(
      MergeFieldTrialStrings("Audio/Disabled/Video/Enabled/", "Audio/Enabled/"),
      "Audio/Enabled/Video/Enabled/");
  EXPECT_EQ(
      MergeFieldTrialStrings("Audio/Enabled/Video/Enabled/", "Audio/Enabled/"),
      "Audio/Enabled/Video/Enabled/");
  EXPECT_EQ(
      MergeFieldTrialStrings("Audio/Enabled/Audio/Enabled/", "Video/Enabled/"),
      "Audio/Enabled/Video/Enabled/");
}

TEST(FieldTrialMergingTest, DiscardsBadInput) {
  EXPECT_EQ(MergeFieldTrialStrings("garbage", "Audio/Enabled/", false),
            "Audio/Enabled/");
  EXPECT_EQ(MergeFieldTrialStrings("Audio/Enabled/", "garbage", false),
            "Audio/Enabled/");
  EXPECT_EQ(MergeFieldTrialStrings("garbage", "garbage", false), "");
  EXPECT_EQ(MergeFieldTrialStrings("Audio/Enabled/Audio/Disabled/",
                                   "Video/Enabled/", false),
            "Video/Enabled/");  // First key is not a valid key by itself.
}

TEST(FieldTrialMergingTest, DchecksBadInput) {
  RTC_EXPECT_DEATH(MergeFieldTrialStrings("Audio/Enabled/", "garbage", true),
                   "Invalid field trials string:");
}

TEST(FieldTrialMergingTest, HandlesEmptyInput) {
  EXPECT_EQ(MergeFieldTrialStrings("", "Audio/Enabled/"), "Audio/Enabled/");
  EXPECT_EQ(MergeFieldTrialStrings("Audio/Enabled/", ""), "Audio/Enabled/");
  EXPECT_EQ(MergeFieldTrialStrings("", ""), "");
}
