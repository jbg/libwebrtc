...
RtpVideoSenderInterface* RtpTransportControllerSend::CreateRtpVideoSender(
  ...
  auto rtp_video_sender = absl::make_unique<RtpVideoSender>(
  ...
  video_stream_encoder->SetFecControllerOverride(rtp_video_sender.get());
  video_rtp_senders_.push_back(std::move(rtp_video_sender));
