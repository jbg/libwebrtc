...
class RtpTransportControllerSend final
 ...
 private:
  struct PacerSettings {
    ...
    bool use_task_queue_pacer() const {
      return tq_enabled.Get() || tq_enabled_alt.Get();
    }

    // TODO(bugs.webrtc.org/10809): Make default enabled and add disabled-flag
    // instead.
    FieldTrialFlag tq_enabled;
    FieldTrialFlag tq_enabled_alt;
