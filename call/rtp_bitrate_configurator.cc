...
rtc::Optional<BitrateConstraints> RtpBitrateConfigurator::UpdateBitrateConfig(
    const BitrateConstraints& bitrate_config) {
  RTC_DCHECK_GE(bitrate_config.min_bitrate_bps, 0);
...
RtpBitrateConfigurator::UpdateBitrateConfigMask(
...
rtc::Optional<BitrateConstraints>
RtpBitrateConfigurator::UpdateCurrentBitrateConfig(
