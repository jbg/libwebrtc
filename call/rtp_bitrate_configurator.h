...
class RtpBitrateConfigurator {
 public:
  ...
  rtc::Optional<BitrateConstraints> UpdateBitrateConfig(
  ...
  // The optional return value is set with new configuration if it was updated.
  rtc::Optional<BitrateConstraints> UpdateBitrateConfigMask(
 ...
 private:
  ...
  rtc::Optional<BitrateConstraints> UpdateCurrentBitrateConfig(
