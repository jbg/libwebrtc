...
bool CanDecreaseResolutionTo(int target_pixels,
  ...
  return target_pixels < max_pixels_per_frame &&
         target_pixels_active_stream >= input_state.min_pixels_per_frame();
}
