...
TEST(RtpVideoSenderTest, CreateWithPreviousStates) {
  ...
  state1.last_shared_frame_id = kState1SharedFrameId;
  RtpPayloadState state2;
  state2.picture_id = kInitialPictureId2;
  state2.tl0_pic_idx = kInitialTl0PicIdx2;
  state2.last_shared_frame_id = kState2SharedFrameId;
  ...
  EXPECT_EQ(kState2SharedFrameId, initial_states[kSsrc1].last_shared_frame_id);
  EXPECT_EQ(kState2SharedFrameId, initial_states[kSsrc2].last_shared_frame_id);
}
}  // namespace webrtc
