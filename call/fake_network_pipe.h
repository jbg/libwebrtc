...
class FakeNetworkPipe : public Transport, public PacketReceiver, public Module {
 ...
 private:
  ...
  // Packets are inserted in the order they are sent. This makes it quick to
  // retreive packets that are to be delivered in the common case where at most
  // a low amount of reordering occurs on the simulated network.
