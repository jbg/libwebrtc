...
struct PacketDelivereyInfo {
  static constexpr int kNotReceived = -1;
  PacketDelivereyInfo(PacketInFlightInfo source, int64_t receive_time_us)
...
class NetworkSimulationInterface {
 public:
  ...
  virtual std::vector<PacketDelivereyInfo> DequeueDeliverablePackets(
...
class SimulatedNetwork : public NetworkSimulationInterface {
 public:
  ...
  std::vector<PacketDelivereyInfo> DequeueDeliverablePackets(
