...
class Call final : public webrtc::Call,
 ...
 public:
  ...
  //  media transport.
  void RegisterRateObserver(MediaTransportInterface* media_transport)
...
void Call::RegisterRateObserver(MediaTransportInterface* media_transport) {
...
webrtc::AudioSendStream* Call::CreateAudioSendStream(
  ...
  RegisterRateObserver(config.media_transport);
...
webrtc::VideoSendStream* Call::CreateVideoSendStream(
  ...
  RegisterRateObserver(/*media_transport=*/nullptr);
