...
const PacketQueue2::Packet& PacketQueue2::Top() const {
...
PacketQueue2::StreamInfo* PacketQueue2::GetHighestPriorityStream() const {
  RTC_CHECK(!stream_priorities_.empty());
  uint32_t ssrc = stream_priorities_.begin()->second;

  // If |stream_infos_| were not marked mutable this would return a
  // const_iterator.
