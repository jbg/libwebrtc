...
RtpPacketSendResult PacketRouter::TimeToSendPacket(
  ...
  RTC_DCHECK_EQ(0, lstrcmpiA(webrtc::ProcessThreadImpl::Current()->name(),
                             "ModuleProcessThread"))
      << webrtc::ProcessThreadImpl::Current()->name();
...
bool PacketRouter::SendTransportFeedback(rtcp::TransportFeedback* packet) {
  ...
  RTC_DCHECK(webrtc::ProcessThreadImpl::Current());
  RTC_DCHECK_EQ(
      0, lstrcmpiA(webrtc::ProcessThreadImpl::Current()->name(), "PacerThread"))
      << webrtc::ProcessThreadImpl::Current()->name();
