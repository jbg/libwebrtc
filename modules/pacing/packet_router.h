...
class PacketRouter : public PacedSender::PacketSender,
 ...
 public:
  ...
  void AddReceiveRtpModule(RtcpFeedbackSenderInterface* rtcp_module,
                           bool remb_candidate);
  void RemoveReceiveRtpModule(RtcpFeedbackSenderInterface* rtcp_module);
 ...
 private:
  ...
  std::vector<RtcpFeedbackSenderInterface*> rtp_receive_modules_
