...
class PacketRouter : public PacedSender::PacketSender,
 ...
 public:
  ...
  void AddReceiveRtpModule(RtcpFeedbackSenderInterface* rtp_module,
                           bool remb_candidate);
  void RemoveReceiveRtpModule(RtcpFeedbackSenderInterface* rtp_module);
 ...
 private:
  ...
  void MaybeRemoveRembModuleCandidate(
      ...
      bool sender) RTC_EXCLUSIVE_LOCKS_REQUIRED(modules_crit_);
  ...
  std::vector<RtcpFeedbackSenderInterface*> rtp_receive_rtcp_modules_
