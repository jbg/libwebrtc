...
namespace webrtc {
namespace {
// Arbitrarily configure for 32 kHz stereo.
constexpr int kRateHz = AudioProcessing::kSampleRate32kHz;
...
TEST(EchoCancellationInternalTest, ExtendedFilter) {
  ...
  echo_canceller.Initialize(kRateHz, kNumChannels, kNumChannels, kNumChannels);
