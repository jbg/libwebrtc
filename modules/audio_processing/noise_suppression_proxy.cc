...
int NoiseSuppressionProxy::set_level(Level level) {
  AudioProcessing::Config config = apm_->GetConfig();
  AudioProcessing::Config::NoiseSuppression::Level new_level;
  switch (level) {
    case NoiseSuppression::kLow:
      new_level = AudioProcessing::Config::NoiseSuppression::kLow;
      break;
    case NoiseSuppression::kModerate:
      new_level = AudioProcessing::Config::NoiseSuppression::kModerate;
      break;
    case NoiseSuppression::kHigh:
      new_level = AudioProcessing::Config::NoiseSuppression::kHigh;
      break;
    case NoiseSuppression::kVeryHigh:
      new_level = AudioProcessing::Config::NoiseSuppression::kVeryHigh;
      break;
    default:
      RTC_NOTREACHED();
  }
