...
class AudioProcessingImpl : public AudioProcessing {
 ...
 private:
  ...
  // The class below is used to hide AudioProcessingImpl members from the code
  // that populates |runtime_settings_|.
  class RuntimeSettingEnqueuer {
   public:
    RuntimeSettingEnqueuer() = delete;
    RuntimeSettingEnqueuer(const RuntimeSettingEnqueuer&) = delete;
    RuntimeSettingEnqueuer& operator=(const RuntimeSettingEnqueuer&) = delete;
    RuntimeSettingEnqueuer(SwapQueue<RuntimeSetting>* runtime_settings);
