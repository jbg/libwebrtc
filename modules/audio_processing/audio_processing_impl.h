...
class AudioProcessingImpl : public AudioProcessing {
 ...
 private:
  ...
  // TODO(webrtc:7494): Remove the the config when the field trial is removed.
  // "WebRTC-Audio-InputVolumeControllerExperiment" field trial override for
  // the input volume controller config.
  absl::optional<InputVolumeController::Config>
      input_volume_controller_config_override_ = absl::nullopt;
