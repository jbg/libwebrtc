...
// processing is done using a combination of direct gains and an emulated analog
// gain functionality. The pre-adjustment is achieved by combining the gain
// value `pre_gain` and the level `emulated_analog_mic_gain_level` to form a
// combined gain of `pre_gain`*`emulated_analog_mic_gain_level`/255 which is
...
class CaptureLevelsAdjuster {
 public:
  ...
  // Enables or disables the emulated analog mic gain.
