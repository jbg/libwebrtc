...
std::unique_ptr<GainController2> CreateAgc2FixedDigitalMode(
  ...
  return std::make_unique<GainController2>(
      config,
      /*input_volume_controller_config=*/absl::nullopt, sample_rate_hz,
      /*num_channels=*/1,
...
TEST(GainController2,
  ...
  auto gain_controller = std::make_unique<GainController2>(
      config, /*input_volume_controller_config=*/absl::nullopt, kSampleRateHz,
      kNumChannels,
      /*use_internal_vad=*/true);
...
TEST(
  ...
  InputVolumeControllerConfig input_volume_controller_config{
  ...
  auto gain_controller = std::make_unique<GainController2>(
      config, input_volume_controller_config, kSampleRateHz, kNumChannels,
      /*use_internal_vad=*/true);
...
TEST(GainController2, ApplyDefaultConfig) {
  auto gain_controller2 = std::make_unique<GainController2>(
      Agc2Config{}, /*input_volume_controller_config=*/absl::nullopt,
...
TEST(GainController2, CheckFinalGainWithAdaptiveDigitalController) {
  ...
  config.fixed_digital.gain_db = 0.0f;
  config.adaptive_digital.enabled = true;
  GainController2 agc2(config, /*input_volume_controller_config=*/absl::nullopt,
...
TEST(GainController2,
  ...
  GainController2 agc2(config, /*input_volume_controller_config=*/absl::nullopt,
                       kSampleRateHz, kStereo,
                       /*use_internal_vad=*/true);
  GainController2 agc2_reference(
      config, /*input_volume_controller_config=*/absl::nullopt, kSampleRateHz,
      kStereo,
      /*use_internal_vad=*/true);
