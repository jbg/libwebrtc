...
int AudioProcessingImpl::EmptyRenderQueueAndConditionallyReinitialize(
  ...
  bool reinitialization_required = false;
  {
    ...
    //   being called.
    // - Access api_format. The lock is released immediately, as we may need to
    //   acquire the render lock as part of the conditional reinitialization.
...
int AudioProcessingImpl::ProcessStream(const float* const* src,
  ...
  RETURN_ON_ERR(EmptyRenderQueueAndConditionallyReinitialize(input_config,
                                                             output_config));
