...
struct AudioProcessingImpl::ApmPrivateSubmodules {
  ApmPrivateSubmodules(std::unique_ptr<CustomProcessing> capture_post_processor_unique_ptr,
                       std::unique_ptr<CustomProcessing> render_pre_processor,
                       rtc::scoped_refptr<EchoDetector> echo_detector,
                       std::unique_ptr<CustomAudioAnalyzer> capture_analyzer)
      : echo_detector(std::move(echo_detector)),
        capture_post_processor_unique_ptr(std::move(capture_post_processor_unique_ptr)),
...
AudioProcessingBuilder& AudioProcessingBuilder::SetCapturePostProcessing(
  ...
  capture_post_processing_unique_ptr_ = std::move(capture_post_processing_unique_ptr);
  return *this;
}
...
int AudioProcessingImpl::ProcessCaptureStreamLocked() {
  ...
  if (private_submodules_->capture_post_processor_unique_ptr) {
    private_submodules_->capture_post_processor_unique_ptr->Process(capture_buffer);
  }
