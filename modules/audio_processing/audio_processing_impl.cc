...
int AudioProcessingImpl::ProcessCaptureStreamLocked() {
  ...
  RTC_DCHECK(!(submodules_.legacy_noise_suppressor &&
  ...
  if (submodules_.echo_control_mobile) {
    ...
    if (submodules_.noise_suppressor) {
      ...
      submodules_.echo_control_mobile->CopyLowPassReference(
          capture_buffer);
      submodules_.legacy_noise_suppressor->ProcessCaptureAudio(
          capture_buffer);
    }
...
bool AudioProcessingImpl::UpdateActiveSubmoduleStates() {
  return submodule_states_.Update(
      ...
      !!submodules_.legacy_noise_suppressor ||
          !!submodules_.noise_suppressor,
      submodules_.gain_control->is_enabled(),
