...
// Returns a config where AGC2 is used for all gain control if
// `input_volume_controller_config_override_` is not empty and either AGC1
// analog or hybrid AGC is active.
