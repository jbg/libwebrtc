...
class VectorFloatFrame {
 public:
  VectorFloatFrame(int num_channels,
                   ...
                   float start_value);
  const MutableFloatAudioFrame* float_frame() const { return &float_frame_; }
  MutableFloatAudioFrame* float_frame() { return &float_frame_; }
 ...
 private:
  ...
  MutableFloatAudioFrame float_frame_;
};
