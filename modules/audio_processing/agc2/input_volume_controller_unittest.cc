...
// contract.
void UpdateRecommendedInputVolume(MonoInputVolumeController& controller,
...
TEST(MonoInputVolumeControllerTest,
  ...
  UpdateRecommendedInputVolume(mono_controller,
...
TEST(MonoInputVolumeControllerTest,
  ...
  UpdateRecommendedInputVolume(mono_controller_1,
  ...
  UpdateRecommendedInputVolume(mono_controller_2,
                               ...
                               kHighSpeechProbability, -15.0f);
  UpdateRecommendedInputVolume(mono_controller_3, kInitialInputVolume,
                               kHighSpeechProbability, -30.0f);
  UpdateRecommendedInputVolume(mono_controller_3,
...
TEST(MonoInputVolumeControllerTest,
  ...
  UpdateRecommendedInputVolume(mono_controller_1,
                               mono_controller_1.recommended_analog_level(),
                               kSpeechProbabilityThreshold - 0.1f, -10.0f);
  UpdateRecommendedInputVolume(mono_controller_2,
                               mono_controller_2.recommended_analog_level(),
                               kSpeechProbabilityThreshold, -10.0f);
...
TEST(MonoInputVolumeControllerTest,
  ...
  UpdateRecommendedInputVolume(mono_controller_1,
                               mono_controller_1.recommended_analog_level(),
                               kHighSpeechProbability, absl::nullopt);
  UpdateRecommendedInputVolume(mono_controller_2,
                               mono_controller_2.recommended_analog_level(),
                               kHighSpeechProbability, -10.0f);
