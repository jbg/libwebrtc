...
// TODO(bugs.chromium.org/9076): Move all the constexprs below to
...
// TODO(bugs.chromium.org/9076): Rename (kOutput)(.+) -> (kOutputDense)(.+).
using rnnoise::kOutputWeights;
using rnnoise::kOutputBias;
