...
void SpectralCorrelator::ComputeAutoCorrelation(
    rtc::ArrayView<const std::complex<float>, kFftSize20ms24kHzBy2Plus1> x,
...
void SpectralCorrelator::ComputeCrossCorrelation(
    rtc::ArrayView<const std::complex<float>, kFftSize20ms24kHzBy2Plus1> x,
    rtc::ArrayView<const std::complex<float>, kFftSize20ms24kHzBy2Plus1> y,
  ...
  RTC_DCHECK_EQ(k, kFftSize20ms24kHzBy2Plus1 - 1);
}
