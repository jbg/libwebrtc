...
// Computes the candidate pitch periods at 12 kHz given the auto-correlation
// values (having inverted lags as indexes) and a view on the 12 kHz pitch
// buffer.
...
// Computes the pitch period at 48 kHz given the pitch period candidates at
// 24 kHz (encoded as inverted lag) and a view on the 24 kHz pitch buffer.
...
// given the initial 48 kHz estimation (computed by `ComputePitchPeriod48kHz()`)
// the last estimated pitch and a view on the 24 kHz pitch buffer.
