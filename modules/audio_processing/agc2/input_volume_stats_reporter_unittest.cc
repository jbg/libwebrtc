...
class InputVolumeStatsReporterTest : public ::testing::TestWithParam<bool> {
 public:
  InputVolumeStatsReporterTest() { metrics::Reset(); }

 protected:
  bool IsAppliedInputVolume() const { return GetParam(); }
 ...
 private:
  absl::string_view VolumeTypeLabel() const {
    return IsAppliedInputVolume() ? "AppliedInputVolume."
                                  : "RecommendedInputVolume.";
  }
};

TEST_P(InputVolumeStatsReporterTest, CheckLogLevelUpdateStatsEmpty) {
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
...
TEST_P(InputVolumeStatsReporterTest, CheckLogLevelUpdateStatsNotEmpty) {
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
  constexpr int kInputVolume = 10;
  stats_reporter.UpdateStatistics(kInputVolume);
...
TEST_P(InputVolumeStatsReporterTest, CheckLevelUpdateStatsForEmptyStats) {
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
...
TEST_P(InputVolumeStatsReporterTest, CheckLevelUpdateStatsAfterNoGainChange) {
  constexpr int kInputVolume = 10;
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
  stats_reporter.UpdateStatistics(kInputVolume);
  stats_reporter.UpdateStatistics(kInputVolume);
...
TEST_P(InputVolumeStatsReporterTest, CheckLevelUpdateStatsAfterGainIncrease) {
  constexpr int kInputVolume = 10;
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
  stats_reporter.UpdateStatistics(kInputVolume);
...
TEST_P(InputVolumeStatsReporterTest, CheckLevelUpdateStatsAfterGainDecrease) {
  constexpr int kInputVolume = 10;
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
  stats_reporter.UpdateStatistics(kInputVolume);
  stats_reporter.UpdateStatistics(kInputVolume - 4);
...
TEST_P(InputVolumeStatsReporterTest, CheckLevelUpdateStatsAfterReset) {
  InputVolumeStatsReporter stats_reporter(IsAppliedInputVolume());
  constexpr int kInputVolume = 10;
  stats_reporter.UpdateStatistics(kInputVolume);
...
INSTANTIATE_TEST_SUITE_P(, InputVolumeStatsReporterTest, ::testing::Bool());
