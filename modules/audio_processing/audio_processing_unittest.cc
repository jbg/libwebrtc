...
TEST(RuntimeSettingTest, TestCtorAndGetters) {
  ...
  {
    AudioProcessing::RuntimeSetting s(Type::kNotSpecified, 0.f);
    EXPECT_EQ(Type::kNotSpecified, s.type());
    EXPECT_EQ(0.f, s.value());
  }
  {
    AudioProcessing::RuntimeSetting s(Type::kNotSpecified, 100.f);
    EXPECT_EQ(Type::kNotSpecified, s.type());
...
TEST(RuntimeSettingTest, TestUsageWithSwapQueue) {
  ...
  AudioProcessing::RuntimeSetting s(Type::kNotSpecified, 1.f);
