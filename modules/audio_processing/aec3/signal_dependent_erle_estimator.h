...
// This class estimates the dependency of the Erle to the input signal and gets
// a more refine estimation of the Erle.
class SignalDependentErleEstimator {
 public:
  ...
  // Gets the Erle per frequency subband.
  ...
  // Erle is required to be an estimation of the average Erle achieved by the
  // linear filter.
 ...
 private:
  ...
  float GetCorrectionFactor(size_t band, size_t n_active_sections);
