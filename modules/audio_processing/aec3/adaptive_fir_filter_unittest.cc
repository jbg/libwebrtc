...
INSTANTIATE_TEST_SUITE_P(
    ...
    [](const ::testing::TestParamInfo<
        AdaptiveFirFilterOneTwoFourEightRenderChannels::ParamType>& info) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(1, 4), ::testing::Values(1, 8)),
    [](const ::testing::TestParamInfo<AdaptiveFirFilterMultiChannel::ParamType>&
           info) {
