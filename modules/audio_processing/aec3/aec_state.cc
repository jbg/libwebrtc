...
bool ResetInitialStateAtEchoPathChange() {
  return !field_trial::IsEnabled("WebRTC-Aec3InitialStateResetKillSwitch");
}
...
AecState::AecState(const EchoCanceller3Config& config,
    ...
    : data_dumper_(
      ...
      transparent_mode_deactivated_(DeactivateTransparentMode()),
      initial_state_reset_at_echo_path_change_(
          ResetInitialStateAtEchoPathChange()),
...
void AecState::HandleEchoPathChange(
  ...
  const auto full_reset = [&]() {
    ...
    if (initial_state_reset_at_echo_path_change_) {
