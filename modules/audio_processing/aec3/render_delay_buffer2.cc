...
RenderDelayBufferImpl2::PrepareCaptureProcessing() {
  ...
  bool excess_render_blocks = DetectExcessRenderBlocks();
...
bool RenderDelayBufferImpl2::DetectExcessRenderBlocks() {
  constexpr int kMaxAllowedExcessRenderBlocks = 5;
  ...
  if (++lost_capture_counter_ > config_.delay.api_call_jitter_blocks) {
    excess_render_detected =
        min_latency_blocks_ > kMaxAllowedExcessRenderBlocks;
