...
class AecState {
 public:
  ...
  bool TransparentMode() const {
    return !transparent_mode_deactivated_ && transparent_state_.Active();
  }
 ...
 private:
  ...
  const bool transparent_mode_deactivated_;
  const bool initial_state_reset_at_echo_path_change_;
