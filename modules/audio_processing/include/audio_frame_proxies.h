...
// previous call to this method, it will trigger an initialization of the
// provided AudioProcessing object.
// The method returns any error codes passed from the AudioProcessing
...
// |frame| must be valid. If changed from the previous call to this method, it
