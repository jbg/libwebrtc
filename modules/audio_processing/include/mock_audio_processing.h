...
class MockAudioProcessing : public ::testing::NiceMock<AudioProcessing> {
 public:
  ...
  MOCK_METHOD(int,
              AnalyzeReverseStream,
              (const float* const*, const StreamConfig& reverse_config),
              (override));
  MOCK_METHOD(int,
              ProcessReverseStream,
              (const float* const*,
  ...
  MOCK_METHOD(bool, was_stream_delay_set, (), (const, override));
  MOCK_METHOD(void, set_stream_key_pressed, (bool key_pressed), (override));
  MOCK_METHOD(void, set_delay_offset_ms, (int offset), (override));
  MOCK_METHOD(int, delay_offset_ms, (), (const, override));
  ...
  MOCK_METHOD(bool,
              CreateAndAttachAecDump,
              (FILE*, int64_t max_log_size_bytes, rtc::TaskQueue*),
              (override));
