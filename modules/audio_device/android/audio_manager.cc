...
#include "modules/audio_device/generated_voiceengine_jni/jni/WebRtcAudioManager_jni.h"
...
AudioManager::JavaAudioManager::JavaAudioManager(
    const jni::ScopedJavaLocalRef<jobject>& audio_manager)
...
void AudioManager::CacheAudioParameters(
    JNIEnv* env,
