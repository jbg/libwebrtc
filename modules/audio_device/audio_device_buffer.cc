...
int32_t AudioDeviceBuffer::SetRecordingSampleRate(uint32_t fsHz) {
  ...
  rtc::AtomicOps::ReleaseStore(&rec_sample_rate_,
                               rtc::dchecked_cast<int>(fsHz));
  return 0;
}

int32_t AudioDeviceBuffer::SetPlayoutSampleRate(uint32_t fsHz) {
  RTC_LOG(INFO) << "SetPlayoutSampleRate(" << fsHz << ")";
  rtc::AtomicOps::ReleaseStore(&play_sample_rate_,
                               rtc::dchecked_cast<int>(fsHz));
  return 0;
}
...
int32_t AudioDeviceBuffer::RecordingSampleRate() const {
  return rtc::dchecked_cast<int32_t>(
      rtc::AtomicOps::AcquireLoad(&rec_sample_rate_));
}

int32_t AudioDeviceBuffer::PlayoutSampleRate() const {
  return rtc::dchecked_cast<int32_t>(
      rtc::AtomicOps::AcquireLoad(&play_sample_rate_));
}

int32_t AudioDeviceBuffer::SetRecordingChannels(size_t channels) {
  RTC_LOG(INFO) << "SetRecordingChannels(" << channels << ")";
  rtc::AtomicOps::ReleaseStore(&rec_channels_,
                               rtc::dchecked_cast<int>(channels));
  return 0;
}

int32_t AudioDeviceBuffer::SetPlayoutChannels(size_t channels) {
  RTC_LOG(INFO) << "SetPlayoutChannels(" << channels << ")";
  rtc::AtomicOps::ReleaseStore(&play_channels_,
                               rtc::dchecked_cast<int>(channels));
  return 0;
}
...
size_t AudioDeviceBuffer::RecordingChannels() const {
  return rtc::dchecked_cast<int32_t>(
      rtc::AtomicOps::AcquireLoad(&rec_channels_));
}

size_t AudioDeviceBuffer::PlayoutChannels() const {
  return rtc::dchecked_cast<int32_t>(
      rtc::AtomicOps::AcquireLoad(&play_channels_));
}
