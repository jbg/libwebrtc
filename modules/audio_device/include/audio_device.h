...
class AudioDeviceModuleForTest : public AudioDeviceModule {
 public:
  // Triggers an internal restart sequence of output audio. Can be used by tests
  // to emulate events corresponding to e.g. removal of an active audio device
  // or other actions which causes the output stream to be disconnected.
