...
void ScreenCapturePortalInterface::RequestSessionUsingProxy(
  ...
  SessionRequest(proxy);
}

void ScreenCapturePortalInterface::SessionRequestHandler(GDBusProxy* proxy,
                                                         GAsyncResult* result,
                                                         gpointer user_data) {
  Scoped<GError> error;
...
void ScreenCapturePortalInterface::SessionRequestResponseSignalHelper(
...
void ScreenCapturePortalInterface::StartRequestedHandler(GDBusProxy* proxy,
                                                         GAsyncResult* result) {
  Scoped<GError> error;
  Scoped<GVariant> variant(
      g_dbus_proxy_call_finish(proxy, result, error.receive()));
