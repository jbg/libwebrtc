...
std::unique_ptr<FullScreenApplicationHandler> FullScreenWindowDetectorMac::CreateApplicationHandler(
    DesktopCapturer::SourceId source_id) {
  return CreateFullScreenMacApplicationHandler(source_id);
}
