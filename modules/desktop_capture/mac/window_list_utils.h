...
// Returns the scale factor / dip-pixel scale of |rect|. Typically |rect| is the
// area of a window. |rect| is in *unscaled* system coordinate, i.e. the primary
// monitor always starts from (0, 0). If |rect| is out of the system display,
// this function returns 1.
float GetScaleFactorOfRect(const MacDesktopConfiguration& desktop_config,
                           DesktopRect rect);
