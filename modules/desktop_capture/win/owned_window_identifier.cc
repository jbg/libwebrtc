...
OwnedWindowIdentifier::OwnedWindowIdentifier(
...
bool OwnedWindowIdentifier::IsSelectedWindowValid() const {
  return selected_window_thread_id != 0;
}

bool OwnedWindowIdentifier::IsWindowOwned(HWND hwnd) const {
...
bool OwnedWindowIdentifier::IsWindowOverlapping(HWND hwnd) const {
