...
class FullScreenApplicationHandler {
 public:
  ...
  // Returns true if the application has full-screen mode which should be
  // handled. Base implementation returns false which could help to save
  // resources in FullScreenWindowDetector (no need to update the list of
  // windows).
