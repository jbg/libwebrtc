...
class FullScreenWindowDetector : public rtc::RefCountedBase {
 ...
 protected:
  // This method should be overriden by platform specific implementation and
  // create an istance of FullScreenApplicationHandler specific for application
  // (Google Chrome, PowerPoint, etc.)
  virtual std::unique_ptr<FullScreenApplicationHandler>
  CreateApplicationHandler(DesktopCapturer::SourceId source_id);
