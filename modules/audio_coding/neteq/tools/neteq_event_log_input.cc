...
NetEqEventLogInput::NextNetEqSetMinimumDelayInfo() const {
...
void NetEqEventLogInput::AdvanceNetEqSetMinimumDelay() {
  next_minimum_delay_event_info_ = source_->NextNetEqSetMinimumDelayEvent();
}
