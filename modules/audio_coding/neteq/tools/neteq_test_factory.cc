...
std::unique_ptr<NetEqTest> NetEqTestFactory::InitializeTest(int argc,
  ...
  stats_plotter_.reset(new NetEqStatsPlotter(
      stats_getter_.get(), stats_getter_->delay_analyzer(), FLAG_matlabplot,
      FLAG_pythonplot, FLAG_concealment_events, output_file_name));
