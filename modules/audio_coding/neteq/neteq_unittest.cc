...
namespace {
// Helped classes and data types and functions for NetEqOutputDelayTest.
...
TestResult DelayLineNetEqTest(size_t delay,
...
TEST(NetEqOutputDelayTest, RunTest) {
  ...
  constexpr int kDelayMs = static_cast<int>(10 * kDelayBlocks);
  const auto result_delay = DelayLineNetEqTest(kDelayBlocks, &output_delayed);
