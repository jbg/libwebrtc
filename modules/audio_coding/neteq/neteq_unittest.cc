  ...
  auto run_test = [](size_t delay, std::vector<int16_t>* output_vector) {
    ...
    class SimEndStatsCollector : public NetEqSimulationEndedCallback {
     public:
      ...
      void SimulationEnded(int64_t /*simulation_time_ms*/,
