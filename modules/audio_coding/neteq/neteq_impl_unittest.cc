...
TEST_F(NetEqImplTest, ReorderedPacket) {
  ...
  rtp_header.extension.set_audio_level(
      AudioLevel(false /* voice_activity */, 42));
  ...
  rtp_header.timestamp -= kPayloadLengthSamples;
  rtp_header.extension.set_audio_level(
      AudioLevel(false /* voice_activity */, 1));
  payload[0] = 1;
  ...
  rtp_header.extension.set_audio_level(
      AudioLevel(false /* voice_activity */, 2));
  payload[0] = 2;
...
TEST_F(NetEqImplTest, InsertRedPayload) {
  ...
  header.extension.set_audio_level(AudioLevel(false /* voice_activity */, 12));
  header.numCSRCs = 1;
