...
// The lower limit is equivalent of |EffectiveMinimumDelay| in packets.
...
void DelayManager::LimitTargetLevel() {
  const int effective_minimum_delay = EffectiveMinimumDelay();
...
int DelayManager::EffectiveMinimumDelay() const {
