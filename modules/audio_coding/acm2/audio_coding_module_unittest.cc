...
TEST_F(AcmReceiverBitExactnessOldApi, 8kHzOutput) {
  std::string others_checksum_reference =
      WebRtc_GetCPUInfo(kAVX2) != 0 ? "6edbfe69b965a8687b8744ed1b8eb5a7"
                                    : "6c204b289486b0695b08a9e94fab1948";
  Run(8000, PlatformChecksum(others_checksum_reference,
...
TEST_F(AcmReceiverBitExactnessOldApi, 16kHzOutput) {
  std::string others_checksum_reference =
      WebRtc_GetCPUInfo(kAVX2) != 0 ? "295f031e051f1770b4ab4107dba768b5"
                                    : "226dbdbce2354399c6df05371042cda3";
  Run(16000, PlatformChecksum(others_checksum_reference,
...
TEST_F(AcmReceiverBitExactnessOldApi, 32kHzOutput) {
  std::string others_checksum_reference =
      WebRtc_GetCPUInfo(kAVX2) != 0 ? "2895e5ab3146eaa78fa6843ed60e7e37"
                                    : "f94665cc0e904d5d5cf0394e30ee4edd";
  Run(32000, PlatformChecksum(others_checksum_reference,
...
TEST_F(AcmReceiverBitExactnessOldApi, 48kHzOutput) {
  std::string others_checksum_reference =
      WebRtc_GetCPUInfo(kAVX2) != 0 ? "640bca210e1b8dd229224d2a0c79ff1f"
                                    : "2955d0b83602541fd92d9b820ebce68d";
  Run(48000, PlatformChecksum(others_checksum_reference,
...
TEST_F(AcmReceiverBitExactnessOldApi, 48kHzOutputExternalDecoder) {
  ...
  std::string others_checksum_reference =
      WebRtc_GetCPUInfo(kAVX2) != 0 ? "640bca210e1b8dd229224d2a0c79ff1f"
                                    : "2955d0b83602541fd92d9b820ebce68d";
  Run(48000,
      PlatformChecksum(others_checksum_reference,
                       "f4a8386a6a49439ced60ed9a7c7f75fd",
                       "d8169dfeba708b5212bdc365e08aee9d",
                       "bd44bf97e7899186532f91235cef444d",
                       "47594deaab5d9166cfbf577203b2563e"),
