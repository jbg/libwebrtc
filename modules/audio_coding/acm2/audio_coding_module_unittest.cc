...
class AudioCodingModuleMtTestOldApi : public AudioCodingModuleTestOldApi {
 protected:
  static constexpr int kNumPackets = 500;
  static constexpr int kNumPullCalls = 500;
...
class AcmReRegisterIsacMtTestOldApi : public AudioCodingModuleTestOldApi {
 protected:
  static constexpr int kRegisterAfterNumPackets = 5;
  static constexpr int kNumPackets = 10;
  static constexpr int kPacketSizeMs = 30;
  static constexpr int kPacketSizeSamples = kPacketSizeMs * 16;
...
class AcmSenderBitExactnessOldApi : public ::testing::Test,
 ...
 protected:
  static constexpr int kTestDurationMs = 1000;
...
class AcmSwitchingOutputFrequencyOldApi : public ::testing::Test,
 ...
 protected:
  static constexpr size_t kTestNumPackets = 50;
  static constexpr int kEncodedSampleRateHz = 16000;
  static constexpr size_t kPayloadLenSamples = 30 * kEncodedSampleRateHz / 1000;
  static constexpr int kPayloadType =
      108;  // Default payload type for PCM16b-wb.
