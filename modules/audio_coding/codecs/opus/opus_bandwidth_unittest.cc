...
constexpr size_t kMaxLoopLengthSamples = kSampleRateHz * 50;  // 10 seconds.
...
TEST(BandwidthAdaptationTest, BandwidthAdaptationTest) {
  ...
  constexpr float kMaxNarrowbandRatio = 0.005;
  constexpr float kMinWidebandRatio = 0.09;
