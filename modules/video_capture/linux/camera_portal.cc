...
CameraPortal::CameraPortal(PortalNotifier* notifier) : notifier_(notifier) {}
...
// static
void CameraPortal::OnProxyRequested(GObject* gobject,
                                    GAsyncResult* result,
                                    gpointer user_data) {
  CameraPortal* that = static_cast<CameraPortal*>(user_data);
  Scoped<GError> error;
...
void CameraPortal::ProxyRequested(GDBusProxy* proxy) {
...
// static
void CameraPortal::OnAccessResponse(GDBusProxy* proxy,
                                    GAsyncResult* result,
                                    gpointer user_data) {
  CameraPortal* that = static_cast<CameraPortal*>(user_data);
  RTC_DCHECK(that);
...
// static
void CameraPortal::OnResponseSignalEmitted(GDBusConnection* connection,
...
void CameraPortal::OnOpenResponse(GDBusProxy* proxy,
                                  GAsyncResult* result,
                                  gpointer user_data) {
  CameraPortal* that = static_cast<CameraPortal*>(user_data);
  RTC_DCHECK(that);
...
void CameraPortal::OnPortalDone(RequestResponse result) {
  notifier_->OnCameraRequestResult(result, pw_fd_);
}
