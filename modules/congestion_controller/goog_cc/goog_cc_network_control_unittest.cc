...
TEST_F(GoogCcNetworkControllerTest,
  ...
  EXPECT_FACTOR_NEAR(tester.GetState().target_rate->target_rate,
                     DataRate::kbps(500), kDataRateMargin);
  ...
  EXPECT_NEAR(tester.target_rate_kbps(), 100, 20);
  EXPECT_FACTOR_NEAR(tester.GetState().target_rate->target_rate,
                     DataRate::kbps(100), kDataRateMargin);
}
