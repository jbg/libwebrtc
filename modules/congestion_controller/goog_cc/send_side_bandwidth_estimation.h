...
class SendSideBandwidthEstimation {
 ...
 private:
  ...
  bool LossBasedBweV1Enabled() const;
  bool LossBasedBweV2Enabled() const;

  bool LossBasedBweV1ReadyForUse() const;
  bool LossBasedBweV2ReadyForUse() const;
  ...
  LossBasedBandwidthEstimation loss_based_bwe_v1_;
  LossBasedBweV2 loss_based_bwe_v2_;
