...
ProbeControllerConfig::ProbeControllerConfig(
    ...
    : first_exponential_probe_scale("p1", 3.0),
      ...
      first_allocation_probe_scale("first_allocation_scale", 1),
      second_allocation_probe_scale("second_allocation_scale", 2),
      allocation_allow_further_probing("allocation_further_probing", false) {
  ParseFieldTrial(
