...
class TrendlineEstimator : public DelayIncreaseDetectorInterface {
 public:
  ...
  // threshold instead of setting a gain.|custom_predictor| is used to indicate
  // whether a customized network_state_predictor is enabled.
  TrendlineEstimator(size_t window_size,
                     double smoothing_coef,
                     double threshold_gain,
                     bool custom_predictor);
