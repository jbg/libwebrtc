...
TEST(ProbeControllerTest, DontProbeWhenNetworkOverusing) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "network_state_interval:5s,not_probe_if_network_overusing_underusing:"
      "true/");
  std::unique_ptr<ProbeController> probe_controller =
      fixture.CreateController();
  ...
  probe_controller->SetNetworkStateEstimate(state_estimate);
  probes = probe_controller->SetEstimatedBitrate(
      kStartBitrate, BandwidthLimitedCause::kNetworkOverusing,
      fixture.CurrentTime());
  ASSERT_TRUE(probes.empty());
...
TEST(ProbeControllerTest, DontProbeWhenNetworkUnderusing) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "network_state_interval:5s,not_probe_if_network_overusing_underusing:"
      "true/");
  ...
  probe_controller->SetNetworkStateEstimate(state_estimate);
  probes = probe_controller->SetEstimatedBitrate(
      kStartBitrate, BandwidthLimitedCause::kNetworkUnderusing,
      fixture.CurrentTime());
  ASSERT_TRUE(probes.empty());
