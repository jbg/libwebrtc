...
ReceiveSideCongestionController::ReceiveSideCongestionController(
    ...
    : env_(env),
      ...
      transport_feedback_generator_(feedback_sender, network_state_estimator),
...
void ReceiveSideCongestionController::OnReceivedPacket(
  ...
  if (has_transport_sequence_number) {
    // Send-side BWE.
    transport_feedback_generator_.OnReceivedPacket(packet);
  } else {
    // Receive-side BWE.
    MutexLock lock(&mutex_);
...
void ReceiveSideCongestionController::OnBitrateChanged(int bitrate_bps) {
  ...
  transport_feedback_generator_.OnSendBandwidthEstimateChanged(
...
TimeDelta ReceiveSideCongestionController::MaybeProcess() {
  ...
  mutex_.Unlock();
  TimeDelta time_until_rep = transport_feedback_generator_.Process(now);
...
void ReceiveSideCongestionController::SetTransportOverhead(
  ...
  RTC_DCHECK_RUN_ON(&sequence_checker_);
  transport_feedback_generator_.SetTransportOverhead(overhead_per_packet);
