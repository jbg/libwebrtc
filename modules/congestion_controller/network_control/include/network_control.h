...
struct NetworkControllerConfig {
  // The initial constraints to start with, theese can be changed at any later
  // time by calls to OnTargetRateConstraints.
  TargetRateConstraints constraints;
  // Initial stream specific configuration, theese are changed at any later time
  // by calls to OnStreamsConfig.
  StreamsConfig stream_based_config;
  // The initial bandwidth estimate to base target rate onn. This should be used
