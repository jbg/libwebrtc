...
namespace webrtc {
namespace {
absl::optional<DataRate> StartRate(int start_bitrate_bps) {
...
void BitrateControllerImpl::SetBitrates(int start_bitrate_bps,
                                        ...
                                        int max_bitrate_bps) {
  {
    ...
    bandwidth_estimation_.SetBitrates(
        StartRate(start_bitrate_bps), DataRate::bps(min_bitrate_bps),
...
void BitrateControllerImpl::ResetBitrates(int bitrate_bps,
                                          ...
                                          int max_bitrate_bps) {
  {
    ...
    bandwidth_estimation_.SetBitrates(
        StartRate(bitrate_bps), DataRate::bps(min_bitrate_bps),
        MaxRate(max_bitrate_bps), Timestamp::ms(clock_->TimeInMilliseconds()));
  }
  MaybeTriggerOnNetworkChanged();
}
