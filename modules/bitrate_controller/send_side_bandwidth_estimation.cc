...
SendSideBandwidthEstimation::SendSideBandwidthEstimation(RtcEventLog* event_log)
    : rtt_backoff_config_(RttBasedBackoffConfig()),
      ...
      last_feedback_rtt_update_(Timestamp::PlusInfinity()),
...
void SendSideBandwidthEstimation::UpdateEstimate(Timestamp at_time) {
  ...
  TimeDelta time_since_rtt = at_time - last_feedback_rtt_update_;
...
void SendSideBandwidthEstimation::UpdateFeedbackRtt(Timestamp at_time,
