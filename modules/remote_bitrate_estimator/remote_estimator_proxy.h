...
class RemoteEstimatorProxy {
 ...
 private:
  ...
  // `is_periodic_update`, this represents sending a periodic feedback
  // message, which will make it update the `periodic_window_start_seq_`
  // variable with the first packet that was not included in the feedback
  // packet, so that the next update can continue from that sequence number.
  //
