...
class RtpRtcp : public Module, public RtcpFeedbackSenderInterface {
 public:
  ...
  // Returns current bitrate in bits/s.
  virtual void BitrateSent(uint32_t* total_rate,
                           uint32_t* video_rate,
                           uint32_t* fec_rate,
                           uint32_t* nack_rate) const = 0;

  // TODO(webrtc:10155): Make pure virtual when downstream project has updated.
  ...
  // or extension/
  virtual uint32_t PacketizationOverheadBps() const;
