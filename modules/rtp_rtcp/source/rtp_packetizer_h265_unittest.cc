...
TEST(RtpPacketizerH265Test, APRespectsFirstPacketReduction) {
  ...
  // The size of HEVC nal_unit_header is 2 bytes, according to 7.3.1.2
  // in HEVC spec. Aggregation packet type is 48, and nuh_temporal_id_plus1
...
TEST(RtpPacketizerH265Test, MixedAPFUA) {
  ...
  // The size of HEVC nal_unit_header is 2 bytes, according to 7.3.1.2
  // in HEVC spec. Aggregation packet type is 49, and nuh_temporal_id_plus1
