...
size_t RtpHeaderExtensionSize(
  ...
  // Max value size of a one-byte header extension, see RFC8285 Section 4.2-4.3.
  static constexpr size_t kOneByteHeaderExtensionMaxValueSize = 16;
  ...
  if (values_size == 0)
    return 0;
  size_t size = kExtensionBlockHeaderSize +
