...
const uint8_t* LookUpInRandomTable(int media_packet_index, int fec_index) {
  ...
  RTC_DCHECK_LT(media_packet_index, arraysize(kPacketMaskRandomTbl));
  return kPacketMaskRandomTbl[media_packet_index][fec_index];
}

const size_t kRandomTableSize = arraysize(kPacketMaskRandomTbl);
