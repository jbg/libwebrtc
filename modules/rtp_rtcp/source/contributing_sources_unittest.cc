...
// TODO(kron,chxg): Set RTP timestamp
...
TEST(ContributingSourcesTest, RecordSources) {
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          RtpSource(kTime1, kCsrc1, RtpSourceType::CSRC, kRtpTimestamp1),
          RtpSource(kTime1, kCsrc2, RtpSourceType::CSRC, kRtpTimestamp1)));
}
...
TEST(ContributingSourcesTest, UpdateSources) {
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          RtpSource(kTime1, kCsrc1, RtpSourceType::CSRC, kRtpTimestamp1),
          RtpSource(kTime2, kCsrc2, RtpSourceType::CSRC, kRtpTimestamp2),
          RtpSource(kTime2, kCsrc3, RtpSourceType::CSRC, kRtpTimestamp2)));
}
...
TEST(ContributingSourcesTest, PurgeOldSources) {
  ...
  EXPECT_THAT(
      csrcs.GetSources(kTime3),
      UnorderedElementsAre(
          RtpSource(kTime3, kCsrc2, RtpSourceType::CSRC, kRtpTimestamp3),
          RtpSource(kTime3, kCsrc3, RtpSourceType::CSRC, kRtpTimestamp3)));
...
TEST(ContributingSourcesTest, AudioLevel) {
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          RtpSource(kTime1 + 1, kCsrc1, RtpSourceType::CSRC, kRtpTimestamp2),
          RtpSource(kTime1, kCsrc2, RtpSourceType::CSRC, 47, kRtpTimestamp1)));
}
