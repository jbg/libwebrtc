...
class TransformableVideoSenderFrame : public TransformableVideoFrameInterface {
 public:
  TransformableVideoSenderFrame(
      ...
      : encoded_data_(encoded_image.GetEncodedData()),
        ...
        capture_time_identifier_ms_(encoded_image.CaptureTimeIdentifierMs()),
  ...
  const absl::optional<int64_t>& GetCaptureTimeIdentifierMs() const override {
 ...
 private:
  ...
  const absl::optional<int64_t> capture_time_identifier_ms_;
