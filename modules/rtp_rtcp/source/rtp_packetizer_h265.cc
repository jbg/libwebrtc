...
void RtpPacketizerH265::NextAggregatePacket(RtpPacketToSend* rtp_packet,
  ...
  /*
   ...
   +-------------+-----------------+
  */
  // Modify type to 48 in PayloadHdr for aggregate packet
  ...
  payload_hdr_h = (payload_hdr_h & kHevcTypeMaskN) |
  ...
  // Do not support DONL for aggregation packets, DONL field is not present.
