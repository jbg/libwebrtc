...
bool RTPSenderVideo::SendVideo(
  ...
  // TODO(eladalon): retransmission_settings_ should generally be replaced
  // by expected_retransmission_time_ms.has_value(). For now, though, only
  // VP8 with an injected frame buffer controller actually controls it.
