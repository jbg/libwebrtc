...
TEST(RtpPacketizerH264Test, DoesNotPacketizeWithEmptyNalUnit) {
  ...
  uint8_t bad_input[] = {0x00, 0x00, 0x01, /* empty NAL unit data */
                         0x00, 0x00, 0x01, 0x01};
  rtc::Buffer frame(bad_input, sizeof bad_input);
  RtpPacketizerH264 packetizer(frame, limits,
                               H264PacketizationMode::NonInterleaved);
...
TEST(RtpPacketizerH264Test, MultipleStapA) {
  ...
  // A lot of small NAL units that will result in multiple STAP-A being
  // generated. Note: the input does not start with a annex-b start code.
  uint8_t input[] = {
      0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x8e,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x04, 0x00,
      0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x8e, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x01, 0x00,
      ...
      0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x00, 0xaf, 0x01, 0x04,
      0x00, 0x19, 0x00, 0x00, 0x01, 0xf9, 0x01, 0x00, 0x00, 0x00, 0x01, 0x8e,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0xf7, 0x01, 0x04,
      0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x8e, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x01, 0x04, 0x00, 0x00, 0x01, 0x00, 0x0b, 0x01, 0x04, 0x00, 0x19,
      0x00, 0x01, 0x00, 0x00, 0x01, 0x8e, 0x00, 0x00};
  rtc::Buffer frame(input, sizeof input);
  RtpPacketizerH264 packetizer(frame, limits,
                               H264PacketizationMode::NonInterleaved);
