...
bool ForwardErrorCorrection::AttemptRecovery(
    RecoveredPacketList* recovered_packets) {
  bool any_packet_recovered = false;
...
DecodeFecResult ForwardErrorCorrection::DecodeFec(
    const ReceivedPacket& received_packet,
    RecoveredPacketList* recovered_packets) {
  ...
  decode_result.any_packet_recovered = AttemptRecovery(recovered_packets);
