 ...
 protected:
  ...
  void SetUpRtpSender(bool pacer, bool populate_network2) {
    rtp_sender_.reset(new RTPSender(
        ...
        &retransmission_rate_limiter_, nullptr, populate_network2, false));
...
TEST_P(RtpSenderTest, AssignSequenceNumberAllowsPaddingOnAudio) {
  ...
  rtp_sender_.reset(new RTPSender(
      ...
      nullptr, &retransmission_rate_limiter_, nullptr, false, false));
  rtp_sender_->SetTimestampOffset(0);
  rtp_sender_->SetSSRC(kSsrc);
...
TEST_P(RtpSenderTestWithoutPacer, SendsPacketsWithTransportSequenceNumber) {
  rtp_sender_.reset(
      new RTPSender(false, &fake_clock_, &transport_, nullptr, nullptr,
                    ...
                    &retransmission_rate_limiter_, nullptr, false, false));
  rtp_sender_->SetSSRC(kSsrc);
  EXPECT_EQ(0, rtp_sender_->RegisterRtpHeaderExtension(
                   kRtpExtensionTransportSequenceNumber,
                   kTransportSequenceNumberExtensionId));
...
TEST_P(RtpSenderTest, OnOverheadChanged) {
  ...
  rtp_sender_.reset(new RTPSender(
      false, &fake_clock_, &transport_, nullptr, nullptr, nullptr, nullptr,
      nullptr, nullptr, nullptr, nullptr, nullptr,
      &retransmission_rate_limiter_, &mock_overhead_observer, false, false));
  rtp_sender_->SetSSRC(kSsrc);
