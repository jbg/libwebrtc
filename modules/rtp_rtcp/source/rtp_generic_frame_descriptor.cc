...
void RtpGenericFrameDescriptor::SetByteRepresentation(
  ...
  // position of the packet in the frame shouldn't be part of.
  // This match how RtpVideoSender where descriptor is passed for authentication
  // before end_of_subframe bit is decided, i.e. it is always 0.
