 ...
 public:
  ...
  class ReceivedFecPacket : public SortablePacket {
   public:
    ...
    absl::InlinedVector<uint32_t, kInlinedSsrcsVectorSize> protected_ssrcs;
    absl::InlinedVector<uint16_t, kInlinedSsrcsVectorSize> seq_num_bases;
    absl::InlinedVector<size_t, kInlinedSsrcsVectorSize>
        packet_mask_offsets;  // Relative start of FEC header.
    absl::InlinedVector<size_t, kInlinedSsrcsVectorSize> packet_mask_sizes;
