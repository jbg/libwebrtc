...
class VideoReceiver : public Module {
 ...
 private:
  ...
  VCMProcessTimer _receiveStatsTimer RTC_GUARDED_BY(module_thread_);
  VCMProcessTimer _retransmissionTimer RTC_GUARDED_BY(module_thread_);
  VCMProcessTimer _keyRequestTimer RTC_GUARDED_BY(module_thread_);
  QpParser qp_parser_ RTC_GUARDED_BY(decoder_thread_);
  ThreadUnsafeOneTimeEvent first_frame_received_ RTC_GUARDED_BY(decoder_thread_);
