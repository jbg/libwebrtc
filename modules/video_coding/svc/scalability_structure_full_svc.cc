...
FrameDependencyStructure ScalabilityStructureL2T3::DependencyStructure() const {
  ...
  t[6].S(1).T(0).Dtis("---SSS").ChainDiffs({1, 1, 1}).FrameDiffs({1});
  t[3].S(0).T(2).Dtis("--D--R").ChainDiffs({3, 2, 1}).FrameDiffs({2});
  t[8].S(1).T(2).Dtis("-----D").ChainDiffs({4, 3, 2}).FrameDiffs({2, 1});
  t[2].S(0).T(1).Dtis("-DS-RR").ChainDiffs({6, 5, 4}).FrameDiffs({4});
  t[7].S(1).T(1).Dtis("----DS").ChainDiffs({7, 6, 5}).FrameDiffs({4, 1});
  t[4].S(0).T(2).Dtis("--D--R").ChainDiffs({9, 8, 7}).FrameDiffs({2});
  t[9].S(1).T(2).Dtis("-----D").ChainDiffs({10, 9, 8}).FrameDiffs({2, 1});
  t[0].S(0).T(0).Dtis("SSSRRR").ChainDiffs({12, 11, 10}).FrameDiffs({8});
  t[5].S(1).T(0).Dtis("---SSS").ChainDiffs({1, 1, 1}).FrameDiffs({8, 1});
  return structure;
}
