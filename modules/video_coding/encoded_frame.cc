  ...
  if (header) {
    switch (header->codec) {
      ...
      case kRtpVideoStereo: {
        ...
        _codecSpecificInfo.codecSpecific.stereo.frame_index =
            header->codecHeader.stereo.frame_index;
        _codecSpecificInfo.codecSpecific.stereo.frame_count =
            header->codecHeader.stereo.frame_count;
        _codecSpecificInfo.codecSpecific.stereo.picture_index =
            header->codecHeader.stereo.picture_index;
        break;
      }
      default: {
        _codecSpecificInfo.codecType = kVideoCodecUnknown;
