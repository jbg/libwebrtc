...
TemplateStructure DefaultTemporalLayers::GetTemplateStructure(
  ...
  switch (num_layers) {
    ...
    case 2: {
      template_structure.templates = {
          Builder().T(0).Dtis("SS"),
          Builder().T(0).Dtis("SS").Fdiffs({2}),
          Builder().T(0).Dtis("SR").Fdiffs({2}),
          Builder().T(1).Dtis("-S").Fdiffs({1}),
          Builder().T(1).Dtis("-D").Fdiffs({1, 2}),
      };
      return template_structure;
    }
    case 3: {
      template_structure.templates = {
          Builder().T(0).Dtis("SSS"),
          Builder().T(0).Dtis("SSS").Fdiffs({4}),
          Builder().T(0).Dtis("SRR").Fdiffs({4}),
          Builder().T(1).Dtis("-SR").Fdiffs({2}),
          Builder().T(1).Dtis("-DR").Fdiffs({2, 4}),
          Builder().T(2).Dtis("--D").Fdiffs({1}),
      };
      return template_structure;
    }
    case 4: {
