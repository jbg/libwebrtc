...
// bool IsNull(const Vp8EncoderConfig& config) {
//   printf("config.temporal_layer_config.has_value() = %d\n",
//   config.temporal_layer_config.has_value());
//   printf("config.rc_target_bitrate.has_value() = %d\n",
//   config.rc_target_bitrate.has_value());
//   printf("config.rc_max_quantizer.has_value() = %d\n",
//   config.rc_max_quantizer.has_value());
//   printf("config.g_error_resilient.has_value() = %d\n",
//   config.g_error_resilient.has_value()); return
//   !config.temporal_layer_config.has_value() &&
//          !config.rc_target_bitrate.has_value() &&
//          !config.rc_max_quantizer.has_value() &&
//          !config.g_error_resilient.has_value();
// }
}  // namespace
