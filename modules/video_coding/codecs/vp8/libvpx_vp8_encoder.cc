...
LibvpxVp8Encoder::LibvpxVp8Encoder(std::unique_ptr<LibvpxInterface> interface)
    : libvpx_(std::move(interface)),
      ...
      whitelist_rate_controller_(webrtc::field_trial::IsEnabled(
          kVp8WhitelistedRateControllerFieldTrial)),
...
bool LibvpxVp8Encoder::HasWhitelistedRateController() const {
