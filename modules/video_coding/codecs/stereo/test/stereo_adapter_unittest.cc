...
TEST_F(TestStereoAdapter, EncodeDecodeI420Frame) {
  ...
  EXPECT_EQ(0, codec_specific_info.codecSpecific.stereo.frame_index);
  EXPECT_EQ(1, codec_specific_info.codecSpecific.stereo.frame_count);
  EXPECT_EQ(0ull, codec_specific_info.codecSpecific.stereo.picture_index);
...
TEST_F(TestStereoAdapter, EncodeDecodeI420AFrame) {
  ...
  EXPECT_EQ(kYUVStream, yuv_info.codecSpecific.stereo.frame_index);
  EXPECT_EQ(kAlphaCodecStreams, yuv_info.codecSpecific.stereo.frame_count);
  EXPECT_EQ(0ull, yuv_info.codecSpecific.stereo.picture_index);
  ...
  EXPECT_EQ(kAXXStream, axx_info.codecSpecific.stereo.frame_index);
  EXPECT_EQ(kAlphaCodecStreams, axx_info.codecSpecific.stereo.frame_count);
  EXPECT_EQ(0ull, axx_info.codecSpecific.stereo.picture_index);
