...
class StereoEncoderAdapter : public VideoEncoder {
 public:
  ...
  StereoEncoderAdapter(cricket::WebRtcVideoEncoderFactory* factory, 
                       cricket::WebRtcVideoEncoderFactory* software_factory);
 ...
 private:
  ...
  cricket::WebRtcVideoEncoderFactory* software_factory_;
  std::vector<std::unique_ptr<VideoEncoder>> encoders_;
  std::vector<std::unique_ptr<VideoEncoder>> test_obj_;
