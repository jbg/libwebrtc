...
std::string VideoStatistic::ToString() const {
  ...
  ss << "\n frame_encoding_time_us: " << frame_encoding_time_us;
  ss << "\n frame_decoding_time_us: " << frame_decoding_time_us;
  ...
  ss << "\n time_to_reach_target_bitrate_sec: "
     << time_to_reach_target_bitrate_sec;
  ss << "\n avg_key_frame_size_bytes: " << avg_key_frame_size_bytes;
  ss << "\n avg_delta_frame_size_bytes: " << avg_delta_frame_size_bytes;
  ss << "\n avg_qp: " << avg_qp;
...
VideoStatistic Stats::SliceAndCalcVideoStatistic(
  ...
  video_stat.target_kbps = target_kbps;
  video_stat.input_fps = input_fps;
  ...
  video_stat.frame_encoding_time_us = encoding_time_us.Mean();
  video_stat.frame_decoding_time_us = decoding_time_us.Mean();
  ...
  video_stat.max_key_frame_delay_sec =
      8 * key_frame_size_bytes.Max() / 1000 / target_kbps;
  video_stat.max_delta_frame_delay_sec =
      8 * delta_frame_size_bytes.Max() / 1000 / target_kbps;
