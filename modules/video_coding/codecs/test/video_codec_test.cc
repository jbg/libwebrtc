...
using VideoCodecTester::PacingSettings::PacingMode::kNoPacing;
using VideoCodecTester::PacingSettings::PacingMode::kRealTime;
...
std::unique_ptr<VideoCodecTester::Decoder> CreateDecoder(
  ...
  if (codec_info.encoder == "libvpx" || codec_info.encoder == "dav1d" ||
      codec_info.encoder == "ffmpeg") {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn({
      EncodeDecodeTestParams({
          ...
          .encoder_settings = {.pacing = {.mode = kNoPacing}},
          .decoder_settings = {.pacing = {.mode = kNoPacing}},
          ...
          EncodeDecodeTestParams({
              .codec = {.type = "VP8",
                        ...
                        .decoder = "mediacodec"},
              .video = kFourPeople_1280x720_30,
              .encoder_settings = {.pacing = {.mode = kRealTime}},
              .decoder_settings = {.pacing = {.mode = kRealTime}},
              .encoding_settings = kConstantRateQvga64Kbps30Fps,
              .test_expectations = {.min_apsnr_y = 30.0},
          })
#endif
