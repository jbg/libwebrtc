...
class VideoProcessor {
 ...
 private:
  ...
  std::map<size_t, size_t> input_frames_rtp_timestamps_
  ...
  std::map<size_t, size_t> num_decoded_spatial_layers_per_frame_
      RTC_GUARDED_BY(sequence_checker_);
  ...
  rtc::Buffer tmp_planar_i420_buffer_;  // Temp storage for format conversion.
