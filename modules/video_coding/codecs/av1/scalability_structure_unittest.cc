...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(SvcTestParam{std::make_unique<ScalabilityStructureL1T2>,
                        /*num_frames_to_generate=*/4, "L1T2"},
           SvcTestParam{std::make_unique<ScalabilityStructureL2T1>,
                        /*num_frames_to_generate=*/3, "L2T1"},
           SvcTestParam{std::make_unique<ScalabilityStructureL2T1Key>,
                        /*num_frames_to_generate=*/3, "L2T1Key"},
           SvcTestParam{std::make_unique<ScalabilityStructureS2T1>,
                        /*num_frames_to_generate=*/3, "S2T1"}),
