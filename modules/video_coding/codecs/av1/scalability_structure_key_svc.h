 ...
 */
#ifndef MODULES_VIDEO_CODING_CODECS_AV1_SCALABILITY_STRUCTURE_KEY_SVC_H_
#define MODULES_VIDEO_CODING_CODECS_AV1_SCALABILITY_STRUCTURE_KEY_SVC_H_
...
class ScalabilityStructureKeySvc : public ScalableVideoController {
 ...
 private:
  ...
  std::bitset<kMaxNumSpatialLayers> spatial_id_is_enabled_ = 0;
...
#endif  // MODULES_VIDEO_CODING_CODECS_AV1_SCALABILITY_STRUCTURE_KEY_SVC_H_
