...
constexpr NamedStructureFactory kFactories[] = {
    ...
    {"L2T1Key", Create<ScalabilityStructureL2T1Key>},
    {"L2T2", Create<ScalabilityStructureL2T2>},
    {"L2T2Key", Create<ScalabilityStructureL2T2Key>},
    {"L2T2KeyShift", Create<ScalabilityStructureL2T2KeyShift>},
    ...
    // to be represented with av1 operation points, thus names inherited from
    // the AV1 spec mention different number of spatial and temporal ids that
    // is actually used.
    {"L3T2_KEY", Create<ScalabilityStructureL2T2Key>},
    {"L3T2_KEY_SHIFT", Create<ScalabilityStructureL2T2KeyShift>},
};
