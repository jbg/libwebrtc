  ...
  if (input_image._frameType == VideoFrameType::kVideoFrameKey) {
    ...
    switch (type_) {
      ...
      case VideoCodecType::kVideoCodecVP8: {
        ...
        // https://source.chromium.org/chromium/chromium/src/+/main:third_party/webrtc/modules/rtp_rtcp/source/video_rtp_depacketizer_vp8.cc;l=189?q=VideoRtpDepacketizerVp8::par
        width_ =
