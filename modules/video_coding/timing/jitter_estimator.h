...
class JitterEstimator {
 ...
 private:
  ...
  double ToFractionalMillis(const TimeDelta& time_delta) const;
  TimeDelta FromFractionalMillis(double millis) const;
  ...
  PercentileFilter<int64_t> avg_frame_size_median_bytes_;
