  ...
  struct Config {
    ...
    std::unique_ptr<StructParametersParser> Parser() {
      return StructParametersParser::Create(
          ...
          "median_frame_size_percentile", &median_frame_size_percentile,
          "frame_size_window", &frame_size_window, "num_stddev_delay_outlier",
    ...
    bool median_frame_size_percentile = false;
