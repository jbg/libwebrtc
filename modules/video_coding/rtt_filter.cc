...
void VCMRttFilter::Update(TimeDelta rtt) {
  ...
  if (filt_fact_count_ > kFilterFactorMax) {
    ...
    // (_filt_fact_max - 1) / _filt_fact_max,
    // e.g., _filt_fact_max = 50 => filt_factor = 49/50 = 0.98
