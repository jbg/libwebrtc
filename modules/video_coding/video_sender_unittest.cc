...
TEST_F(TestVideoSenderWithVp8, MAYBE_FixedTemporalLayersStrategy) {
  const int low_b = codec_bitrate_kbps_ * kLayerRateAlloction[2][0];
  const int mid_b = codec_bitrate_kbps_ * kLayerRateAlloction[2][1];
  const int high_b = codec_bitrate_kbps_ * kLayerRateAlloction[2][2];
  {
