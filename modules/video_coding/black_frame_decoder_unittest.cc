...
TEST_F(BlackFrameDecoderTest, H264) {
  ...
  EncodedImage image = MakeImage(VideoFrameType::kVideoFrameKey);
  // Borrowed from H264SpsParserTest but prefixed 0s for start code and NAL
  // type.
  /*
  const uint8_t buffer[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x7A, 0x00, 0x1F,
  0xBC, 0xD9, 0x40, 0x50, 0x05, 0xBA, 0x10, 0x00, 0x00, 0x03, 0x00, 0xC0, 0x00,
