...
class GenericFrameInfo::Builder {
 public:
  ...
  Builder& tl(int temporal_id);
  Builder& sl(int spatial_id);
  Builder& indications(const std::string& indication_symbols);
  Builder& fdiffs(absl::InlinedVector<int, 10> frame_diffs);
  Builder& cdiffs(absl::InlinedVector<int, 10> chain_diffs);
