...
class RtpFrameReferenceFinder {
 public:
  ...
  explicit RtpFrameReferenceFinder(int64_t frame_id_offset);
  ~RtpFrameReferenceFinder();
  ...
  ReturnVector ManageFrame(std::unique_ptr<video_coding::RtpFrameObject> frame);
 ...
 private:
  void ApplyFrameIdOffset(ReturnVector& frames);
  ...
  const int64_t frame_id_offset_;
