...
class FrameScheduler {
 public:
  ...
  // Informs the scheduler that the frame buffer has changed. The scheduler will
 ...
 private:
  ...
  bool FrameRtpTimestampsOutOfOrder(uint32_t rtp) const;
  bool TooManyFramesQueued() const;
