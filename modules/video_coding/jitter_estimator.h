...
class VCMJitterEstimator {
 ...
 private:
  ...
  // Input:
  //          - frame_delay      : Delay-delta calculated by UTILDelayEstimate.
  //          - delta_frame_size : Frame size delta, i.e. frame size at time T
  //                             : minus frame size at time T-1.
  void KalmanEstimateChannel(TimeDelta frame_delay, double delta_frame_size);
  ...
  // Input:
  //          - frame_delay       : Delay-delta calculated by UTILDelayEstimate.
  //          - delta_frame_size : Frame size delta, i.e. frame size at time
