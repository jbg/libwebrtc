...
from the [Starlark][] script [config.star][] that defines a unified config using
[lucicfg][]. Its documentation should be the primary source of information.
...
`*.cfg` files. Re-check the diffs in generated files to confirm that your change
