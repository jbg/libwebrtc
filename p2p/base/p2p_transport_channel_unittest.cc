...
const auto kNonAlphaNumeric = [](char c) { return !std::isalnum(c); };

std::string SafeString(std::string& str) {
  absl::c_replace_if(str, kNonAlphaNumeric, '_');
  if (str.empty()) {
    static const std::string empty_str = "__empty__";
    return empty_str;
  }
  return str;
}

const auto kUnaryFieldTrialParamToString = [](const auto& info) {
  std::string name = info.param;
  return SafeString(name);
};

const auto kBoolXFieldTrialsParamToString = [](const auto& info) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values("",
           ...
           "WebRTC-IceControllerRefactor/Enabled/",
           "WebRTC-IceFieldTrials/enable_goog_ping:true/"
           "WebRTC-IceControllerRefactor/Enabled/"),
    kUnaryFieldTrialParamToString);

INSTANTIATE_TEST_SUITE_P(P2PTransportChannelTestWithFieldTrials,
                         P2PTransportChannelTestWithFieldTrials,
                         Values("", "WebRTC-IceControllerRefactor/Enabled/"),
                         kUnaryFieldTrialParamToString);
...
INSTANTIATE_TEST_SUITE_P(P2PTransportChannelIceControllerTest,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Combine(Values(true, false),
            Values("", "WebRTC-IceControllerRefactor/Enabled/")),
    kBoolXFieldTrialsParamToString);
