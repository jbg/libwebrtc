...
void P2PTransportChannel::SwitchSelectedConnection(Connection* conn) {
  ...
  if (selected_connection_) {
    ...
    network_route.transport_overhead_per_packet = GetIceTransportOverhead();
  }
...
int P2PTransportChannel::GetNetworkLayerOverhead(const Candidate& candidate) {
...
int P2PTransportChannel::GetTransportLayerOverhead(const Candidate& candidate) {
