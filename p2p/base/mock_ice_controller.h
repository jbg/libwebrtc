...
class MockIceControllerFactory : public cricket::IceControllerFactoryInterface {
 public:
  ...
  std::unique_ptr<cricket::IceControllerInterface> Create(
    ...
    std::unique_ptr<MockIceController> instance =
        std::make_unique<MockIceController>(args);
    most_recent_instance_ = instance.get();
    return instance;
  }

  const MockIceController* most_recent_instance() const {
 ...
 private:
  const MockIceController* most_recent_instance_;
};
