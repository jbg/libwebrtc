...
class RegatheringControllerInterface {
 public:
  ...
  virtual void ScheduleRegatheringOnAllNetworks(int delay_ms_from_now,
                                                bool repeated) = 0;
  virtual void ScheduleRegatheringOnFailedNetworks(int delay_ms_from_now,
                                                   bool repeated) = 0;
...
class BasicRegatheringController : public RegatheringControllerInterface {
 public:
  ...
  void ScheduleRegatheringOnAllNetworks(int delay_ms_from_now,
                                        bool repeated) override;
  void ScheduleRegatheringOnFailedNetworks(int delay_ms_from_now,
                                           bool repeated) override;
 ...
 private:
  ...
  void RegatherOnAllNetworks(
      bool repeated,
      rtc::Optional<int> next_schedule_delay_ms_from_now);
