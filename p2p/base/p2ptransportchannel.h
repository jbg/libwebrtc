...
class P2PTransportChannel : public IceTransportInternal {
 public:
  ...
  // Public for unit tests.
  webrtc::BasicRegatheringController* regather_controller() {
    return regather_controller_.get();
  }
 ...
 private:
  ...
  std::unique_ptr<webrtc::BasicRegatheringController> regather_controller_ =
      nullptr;
