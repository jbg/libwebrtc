...
class TCPPort : public Port {
 ...
 protected:
  ...
  void OnNewConnection(rtc::AsyncPacketListenSocket* socket,
 ...
 private:
  ...
  void OnAddressReady(rtc::AsyncPacketListenSocket* socket,
                      const rtc::SocketAddress& address);

  bool allow_listen_;
  std::unique_ptr<rtc::AsyncPacketListenSocket> listen_socket_;
  int error_;
