...
class TCPPort : public Port {
 public:
  static std::unique_ptr<TCPPort> Create(const CreatePortArgs& args,
                                         uint16_t min_port,
                                         uint16_t max_port,
                                         bool allow_listen) {
  ...
  [[deprecated(
      "Pass arguments using CreatePortArgs")]] static std::unique_ptr<TCPPort>
 ...
 protected:
  TCPPort(const CreatePortArgs& args,
          uint16_t min_port,
          uint16_t max_port,
          bool allow_listen);
