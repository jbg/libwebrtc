...
class VideoMediaShimChannel : public VideoMediaChannel {
 public:
  ...
  // Seems like it's a receive-only function:
  // void OnPacketReceived(const webrtc::RtpPacketReceived& packet) override {
  //   send_impl()->OnPacketReceived(packet);
  //}
  ...
  // Send_Implementation of MediaSendChannelInterface
  ...
  // Seems to be a send-only thing
  //  void OnPacketSent(const rtc::SentPacket& sent_packet) override {
  //  receive_impl()->OnPacketSent(sent_packet);
  // }
  // void OnReadyToSend(bool ready) override {
  // receive_impl()->OnReadyToSend(ready); } void
  // OnNetworkRouteChanged(absl::string_view transport_name,
  //                           const rtc::NetworkRoute& network_route) override
  //                           {
  //  receive_impl()->OnNetworkRouteChanged(transport_name, network_route);
  // }
  // void SetExtmapAllowMixed(bool extmap_allow_mixed) override {
  //  receive_impl()->SetExtmapAllowMixed(extmap_allow_mixed);
  // }
  // bool ExtmapAllowMixed() const override { return
  // receive_impl()->ExtmapAllowMixed(); } void

  // bool HasNetworkInterface() const override {
  //   return receive_impl()->HasNetworkInterface();
  // }
