...
class VideoAdapterTestVariableScaleFactor : public VideoAdapterTest {
 public:
  VideoAdapterTestVariableScaleFactor()
      : VideoAdapterTest("WebRTC-Video-VariableScaleFactor/Enabled/") {}
};
...
TEST_P(VideoAdapterTestVariableScaleFactor, AdaptResolutionInStepsFirst3_4) {
  const int kWidth = 1280;
  const int kHeight = 720;
...
TEST_P(VideoAdapterTestVariableScaleFactor, AdaptResolutionInStepsFirst2_3) {
...
TEST_P(VideoAdapterTestVariableScaleFactor, AdaptResolutionInStepsFirst2x2_3) {
