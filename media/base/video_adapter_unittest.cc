...
class VideoAdapterTestVariableScale : public VideoAdapterTest {
 public:
  VideoAdapterTestVariableScale()
...
TEST_P(VideoAdapterTest, AdaptResolutionInSteps720p) {
  const int kWidth = 1280;
  const int kHeight = 720;
  OnOutputFormatRequest(kWidth, kHeight, absl::nullopt);  // 16:9 aspect.

  // Scale factors: 3/4, 1/2, 3/8, 1/4, 3/16, 1/8.
...
TEST_P(VideoAdapterTest, AdaptResolutionInSteps1080p) {
  const int kWidth = 1920;
  const int kHeight = 1080;
  OnOutputFormatRequest(kWidth, kHeight, absl::nullopt);  // 16:9 aspect.

  // Scale factors: 3/4, 1/2, 3/8, 1/4, 3/16, 1/8, 3/16, 1/16, 3/32.
  const int kExpectedWidths[] = {1440, 960, 720, 480, 360, 240, 180, 120, 90};
  const int kExpectedHeights[] = {810, 540, 405, 270, 201, 135, 99, 67, 48};
...
TEST_P(VideoAdapterTestVariableScale, AdaptResolutionInSteps720p) {
  const int kWidth = 1280;
  const int kHeight = 720;
  OnOutputFormatRequest(kWidth, kHeight, absl::nullopt);  // 16:9 aspect.
...
TEST_P(VideoAdapterTestVariableScale, AdaptResolutionInSteps1080p) {
  const int kWidth = 1920;
  const int kHeight = 1080;
  OnOutputFormatRequest(kWidth, kHeight, absl::nullopt);  // 16:9 aspect.

  // Scale factors: 2/3, 1/2, 1/3, 1/4, 1/6, 1/8, 1/12.
