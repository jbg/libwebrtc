...
class MediaChannel : public sigslot::has_slots<> {
 public:
  ...
  // Returns a previously set frame_encryptor. If none is set nullptr is
  // returned.
  virtual webrtc::FrameEncryptorInterface* GetFrameEncryptor() const;
  ...
  // Returns a prevoiusly set frame_decryptor. If none is set nullptr is
  // returned.
  virtual webrtc::FrameDecryptorInterface* GetFrameDecryptor() const;
