...
class WebRtcVoiceEngineTestFake : public ::testing::TestWithParam<bool> {
 public:
  ...
  void SetSendParameters(const cricket::AudioSenderParameters& params) {
    ASSERT_TRUE(channel_);
  ...
  void TestMaxSendBandwidth(const cricket::AudioCodec& codec,
    ...
    cricket::AudioSenderParameters parameters;
  ...
  void SetGlobalMaxBitrate(const cricket::AudioCodec& codec, int bitrate) {
    cricket::AudioSenderParameters send_parameters;
 ...
 protected:
  ...
  cricket::AudioSenderParameters send_parameters_;
...
TEST_P(WebRtcVoiceEngineTestFake, SetSendCodecsOpusPcmuSwitching) {
  ...
  cricket::AudioSenderParameters opus_parameters;
  ...
  cricket::AudioSenderParameters pcmu_parameters;
...
TEST_P(WebRtcVoiceEngineTestFake, SetOptionOverridesViaChannels) {
  ...
  // AEC and AGC and NS
  cricket::AudioSenderParameters parameters_options_all = send_parameters_;
  ...
  // unset NS
  cricket::AudioSenderParameters parameters_options_no_ns = send_parameters_;
  ...
  // unset AGC
  cricket::AudioSenderParameters parameters_options_no_agc = send_parameters_;
  ...
  cricket::AudioSenderParameters parameters_options_no_agc_nor_ns =
      send_parameters_;
...
TEST_P(WebRtcVoiceEngineTestFake, ConfiguresAudioReceiveStreamRtpExtensions) {
  ...
  channel_->SetRecvParameters(cricket::AudioReceiverParameters());
  for (uint32_t ssrc : ssrcs) {
    EXPECT_THAT(
        receive_channel_->GetRtpReceiveParameters(ssrc).header_extensions,
        IsEmpty());
