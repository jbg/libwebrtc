...
class WebRtcVideoEngineTest : public ::testing::Test {
 ...
 protected:
  ...
  void RtpCapabilitySupported(const char* uri, bool supported) const;
...
TEST_F(WebRtcVideoEngineTest, SupportsTimestampOffsetHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kTimestampOffsetUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsAbsoluteSenderTimeHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kAbsSendTimeUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsTransportSequenceNumberHeaderExtension) {
  RtpCapabilities capabilities;
  engine_.AppendCapabilities(&capabilities);
  RtpCapabilitySupported(RtpExtension::kTransportSequenceNumberUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsVideoRotationHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kVideoRotationUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsPlayoutDelayHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kPlayoutDelayUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsVideoContentTypeHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kVideoContentTypeUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsVideoTimingHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kVideoTimingUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsFrameMarkingHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kFrameMarkingUri, true);
}

TEST_F(WebRtcVideoEngineTest, SupportsColorSpaceHeaderExtension) {
  RtpCapabilitySupported(RtpExtension::kColorSpaceUri, true);
}

TEST_F(WebRtcVideoEngineTest, AdvertiseGenericDescriptor) {
  RtpCapabilitySupported(RtpExtension::kGenericFrameDescriptorUri, false);
}
...
TEST_F(WebRtcVideoEngineTestWithGenericDescriptor, AdvertiseGenericDescriptor) {
  RtpCapabilitySupported(RtpExtension::kGenericFrameDescriptorUri, true);
}
...
void WebRtcVideoEngineTest::RtpCapabilitySupported(const char* uri,
