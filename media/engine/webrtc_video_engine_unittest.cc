...
TEST_F(WebRtcVideoChannelTest, GetStatsTranslatesDecodeStatsCorrectly) {
  ...
  stats.jitter_buffer_target_delay_seconds = 55;
  stats.jitter_buffer_emitted_count = 6;
  stats.jitter_buffer_minimum_delay_seconds = 50;
  ...
  EXPECT_EQ(stats.jitter_buffer_target_delay_seconds,
  ...
  EXPECT_EQ(stats.jitter_buffer_minimum_delay_seconds,
