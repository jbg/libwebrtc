...
class FakeAudioReceiveStream final : public webrtc::AudioReceiveStream {
 public:
  ...
  double base_mininum_delay_ms() const { return base_mininum_delay_ms_; }
 ...
 private:
  ...
  bool SetBaseMinimumPlayoutDelayMs(int delay_ms) override {
    base_mininum_delay_ms_ = delay_ms;
    return true;
  }
  int GetBaseMinimumPlayoutDelayMs() const override {
    return base_mininum_delay_ms_;
  }
  ...
  bool started_ = false;
  double base_mininum_delay_ms_ = 0;
};
