...
class VideoAnalyzer : public PacketReceiver,
 ...
 private:
  ...
  void PrintResults() {
    ...
    rtc::CritScope crit(&comparison_lock_);
    test::PrintResultMeanAndError("psnr", "", test_label_.c_str(), psnr_.Mean(),
                                  psnr_.StandardDeviation(), "dB", false);
    test::PrintResultMeanAndError("ssim", "", test_label_.c_str(), ssim_.Mean(),
    ...
    test::PrintResultMeanAndError("total_delay_incl_network", "",
                                  test_label_.c_str(), end_to_end_.Mean(),
                                  end_to_end_.StandardDeviation(), "ms", false);
    test::PrintResultMeanAndError("time_between_rendered_frames", "",
                                  test_label_.c_str(), rendered_delta_.Mean(),
                                  rendered_delta_.StandardDeviation(), "ms",
                                  false);
    test::PrintResultMeanAndError(
    ...
    test::PrintResult("cpu_usage", "", test_label_.c_str(),
      ...
      // will be flaky.
    test::PrintResultMeanAndError("memory_usage", "", memory_usage_.Mean(),
