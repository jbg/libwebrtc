...
void VideoQualityTest::RunWithAnalyzer(const Params& params) {
  ...
  if (!params.logging.rtc_event_log_name.empty()) {
    Environment env = CreateEnvironment(task_queue_factory_.get());
  ...
  SendTask(task_queue(), [this, &params, &send_transport, &recv_transport]() {
    CallConfig send_call_config(CreateEnvironment(send_event_log_.get()));
    CallConfig recv_call_config(CreateEnvironment(recv_event_log_.get()));
