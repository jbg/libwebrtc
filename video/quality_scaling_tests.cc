...
class QualityScalingTest : public test::CallTest {
 protected:
  ...
  const absl::optional<VideoEncoder::ResolutionBitrateLimits>
      kSinglecastLimits720pVp8 = EncoderInfoSettings::
          GetDefaultSinglecastBitrateLimitsForResolutionVp8(1280 * 720);
  const absl::optional<VideoEncoder::ResolutionBitrateLimits>
      kSinglecastLimits360pVp9 = EncoderInfoSettings::
          GetDefaultSinglecastBitrateLimitsForResolutionVp9(640 * 360);
};
