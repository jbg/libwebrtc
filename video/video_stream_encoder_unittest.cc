...
class FakeNV12NativeBuffer : public webrtc::VideoFrameBuffer {
 public:
  ...
  rtc::scoped_refptr<VideoFrameBuffer> ToMemoryFrameBuffer(
  ...
  class TestEncoder : public test::FakeEncoder {
   public:
    ...
    void SetPreferredPixelFormats(
        std::vector<VideoFrameBuffer::Type> pixel_formats) {
      MutexLock lock(&local_mutex_);
   ...
   private:
    ...
    absl::optional<VideoFrameBuffer::Type> last_input_pixel_format_
        RTC_GUARDED_BY(local_mutex_);
    std::vector<VideoFrameBuffer::Type> preferred_pixel_formats_
        RTC_GUARDED_BY(local_mutex_);
  };
