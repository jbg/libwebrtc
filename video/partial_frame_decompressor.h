...
#ifndef VIDEO_PARTIAL_FRAME_DECOMPRESSOR_H_
#define VIDEO_PARTIAL_FRAME_DECOMPRESSOR_H_
...
class PartialFrameDecompressor {
 public:
  PartialFrameDecompressor();
  ~PartialFrameDecompressor();
...
#endif  // VIDEO_PARTIAL_FRAME_DECOMPRESSOR_H_
