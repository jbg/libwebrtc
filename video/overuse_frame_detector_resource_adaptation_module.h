...
class OveruseFrameDetectorResourceAdaptationModule
 ...
 public:
  ...
  // rate has updated.
  // TODO(https://crbug.com/webrtc/11222): When the VideoSourceController is no
  // longer aware of DegradationPreference, and the degradation
  // preference-related logic resides within this class, we can remove this
  // dependency on the VideoSourceController.
