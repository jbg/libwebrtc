...
namespace {
static const int kPCFullStackTestDurationSecs = 45;
...
struct ParamsWithLogging : public VideoQualityTest::Params {
 public:
  ParamsWithLogging() { this->config = BuiltInNetworkBehaviorConfig(); }
};
...
TEST_P(PCGenericDescriptorTest, ForemanCifPlr5Vp9) {
  ...
  foreman_cif.analyzer = {GetTestName("foreman_cif_delay_50_0_plr_5_VP9"), 0.0,
                          0.0, kPCFullStackTestDurationSecs};
...
#endif
TEST(PCFullStackTest, MAYBE_ParisQcifWithoutPacketLoss) {
  auto fixture = CreateVideoQualityTestFixture();
...
TEST_P(PCGenericDescriptorTest, ForemanCif30kbpsWithoutPacketLoss) {
  ...
  foreman_cif.analyzer = {GetTestName("foreman_cif_30kbps_net_delay_0_0_plr_0"),
                          0.0, 0.0, kPCFullStackTestDurationSecs};
  foreman_cif.call.generic_descriptor = GenericDescriptorEnabled();
  fixture->RunWithAnalyzer(foreman_cif);
}
...
TEST(PCFullStackTest, VP9SVC_3SL_Low) {
  ...
  simulcast.call.send_side_bwe = true;
  simulcast.video[0] = SvcVp9Video();
  simulcast.analyzer = {"vp9svc_3sl_low", 0.0, 0.0,
                        kPCFullStackTestDurationSecs};
  simulcast.ss[0] = {
...
TEST_P(PCDualStreamsTest,
  ...
  dual_streams.analyzer = {test_label, 0.0, 0.0, kPCFullStackTestDurationSecs};
