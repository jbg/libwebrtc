...
void VideoStreamEncoder::SetEncoderRates(
  ...
  // pacer is full. We do this since its unclear how current encoder
  // implementations behave when given a zero target bitrate. TODO(perkj): Make
  // sure all known encoder implementations handle zero target bitrate and
  // remove this check.
