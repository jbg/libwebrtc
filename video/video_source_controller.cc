...
void VideoSourceController::SetSource(
  ...
  rtc::VideoSinkWants wants;
  {
    ...
    old_source = source_;
    source_ = source;
    wants = CurrentSettingsToSinkWants(degradation_preference);
  }
...
rtc::VideoSinkWants
VideoSourceController::CurrentSettingsToSinkWantsForTesting(DegradationPreference degradation_preference) const {
  rtc::CritScope lock(&crit_);
  return CurrentSettingsToSinkWants(degradation_preference);
}

rtc::VideoSinkWants VideoSourceController::CurrentSettingsToSinkWants(
