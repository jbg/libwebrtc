...
VideoFrame CreateFrame(rtc::scoped_refptr<I420Buffer> buf) {
  return VideoFrame(buf, VideoRotation::kVideoRotation_0, 0);
}
...
TEST(PartialFrameDecompressor, FullPictureUpdates) {
  PartialFrameDecompressor decompressor;

  // Full pic.
  auto full_pic1 = CreatePicture(kWidth, kHeight, kCol1);
  VideoFrame::PartialFrameDescription desc1{0, 0, kWidth, kHeight};
  VideoFrame frame1 = CreateFrame(full_pic1);

  // Full pic.
  auto full_pic2 = CreatePicture(kWidth, kHeight, kCol2);
  VideoFrame::PartialFrameDescription desc2{0, 0, kWidth, kHeight};
...
TEST(PartialFrameDecompressor, PartialUpdateFirstFails) {
  PartialFrameDecompressor decompressor;
...
TEST(PartialFrameDecompressor, PartialUpdate) {
  PartialFrameDecompressor decompressor;
  ...
  VideoFrame::PartialFrameDescription desc2{30, 40, kWidth, kHeight};
  VideoFrame frame2 = CreateFrame(full_pic2);
...
TEST(PartialFrameDecompressor, SetsUnchangedFlag) {
  PartialFrameDecompressor decompressor;

  auto full_pic1 = CreatePicture(kWidth, kHeight, kCol1);
  VideoFrame::PartialFrameDescription desc1{0, 0, kWidth,
                                            kHeight};  // Full pic.
  VideoFrame frame1 = CreateFrame(full_pic1);
  ...
  // Empty update.
  auto full_pic3 = CreatePicture(0, 0, kCol1);
  VideoFrame::PartialFrameDescription desc3{0, 0, kWidth, kHeight};
  VideoFrame frame3 = CreateFrame(full_pic3);

  EXPECT_TRUE(
      decompressor.ApplyPartialUpdate(full_pic1.get(), &frame1, &desc1));
  EXPECT_FALSE(frame1.unchanged());
  ...
  EXPECT_TRUE(
      decompressor.ApplyPartialUpdate(full_pic3.get(), &frame3, &desc3));
  EXPECT_TRUE(frame3.unchanged());
}

TEST(PartialFrameDecompressor, PartialUpdateFailsForOddXOffset) {
  PartialFrameDecompressor decompressor;
  ...
  auto full_pic2 = CreatePicture(10, 20, kCol2);
  // Offset is odd.
  VideoFrame::PartialFrameDescription desc2{31, 40, kWidth, kHeight};
  VideoFrame frame2 = CreateFrame(full_pic2);
...
TEST(PartialFrameDecompressor, PartialUpdateFailsForOddYOffset) {
  PartialFrameDecompressor decompressor;
  ...
  auto full_pic2 = CreatePicture(10, 20, kCol2);
  // Offset is odd.
  VideoFrame::PartialFrameDescription desc2{30, 41, kWidth, kHeight};
  VideoFrame frame2 = CreateFrame(full_pic2);
...
TEST(PartialFrameDecompressor, PartialUpdateFailsForOddWidth) {
  PartialFrameDecompressor decompressor;
...
TEST(PartialFrameDecompressor, PartialUpdateWorksForOddWidthAtTheEnd) {
  PartialFrameDecompressor decompressor;

  // Full pic. Odd resolution.
  auto full_pic1 = CreatePicture(kWidth + 1, kHeight + 1, kCol1);
  VideoFrame::PartialFrameDescription desc1{0, 0, kWidth + 1, kHeight + 1};
  VideoFrame frame1 = CreateFrame(full_pic1);
...
TEST(PartialFrameDecompressor, PartialUpdateFailsForOddNotAtEnd) {
  PartialFrameDecompressor decompressor;
...
TEST(PartialFrameDecompressor, PartialUpdateWithWrongFullResolution) {
  PartialFrameDecompressor decompressor;
  ...
  // Partial pic update.
  auto full_pic2 = CreatePicture(10, 20, kCol2);
  VideoFrame::PartialFrameDescription desc2{30, 40, kWidth + 100,
                                            kHeight + 100};
  VideoFrame frame2 = CreateFrame(full_pic2);
...
TEST(PartialFrameDecompressor, FullPictureUpdatesCanChangeResolution) {
  PartialFrameDecompressor decompressor;
  ...
  VideoFrame::PartialFrameDescription desc2{0, 0, kWidth + 100, kHeight + 100};
  VideoFrame frame2 = CreateFrame(full_pic2);
