...
bool OveruseFrameDetectorResourceAdaptationModule::CanAdaptUp(
  ...
  // TODO(hbos): We may also not adapt up if the VideoSourceRestrictor disallows
  // it, due to other BalancedSettings logic or CanAdaptUpResolution(). Make
  // this method predict all cases of not adapting.
  return true;
}
...
bool OveruseFrameDetectorResourceAdaptationModule::CanAdaptDown(
  ...
  // TODO(hbos): We may also not adapt down if the VideoSourceRestrictor
  // disallows it or due to other BalancedSettings logic. Make this method
  // predict all cases of not adapting.
  return true;
}
