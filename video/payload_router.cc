...
void CopyCodecSpecific(const CodecSpecificInfo* info, RTPVideoHeader* rtp) {
  ...
  switch (info->codecType) {
    ...
    case kVideoCodecStereo: {
      ...
      rtp->codecHeader.stereo.indices.frame_index =
          info->codecSpecific.stereo.indices.frame_index;
      rtp->codecHeader.stereo.indices.frame_count =
          info->codecSpecific.stereo.indices.frame_count;
      rtp->codecHeader.stereo.indices.picture_index =
          info->codecSpecific.stereo.indices.picture_index;
      return;
    }
