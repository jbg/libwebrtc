...
void CopyCodecSpecific(const CodecSpecificInfo* info, RTPVideoHeader* rtp) {
  ...
  switch (info->codecType) {
    ...
    case kVideoCodecStereo: {
      ...
      rtp->codecHeader.stereo.frame_index =
          info->codecSpecific.stereo.frame_index;
      rtp->codecHeader.stereo.frame_count =
          info->codecSpecific.stereo.frame_count;
      rtp->codecHeader.stereo.picture_index =
          info->codecSpecific.stereo.picture_index;
      return;
    }
