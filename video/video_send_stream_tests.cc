...
class Vp9HeaderObserver : public test::SendTest {
 ...
 protected:
  ...
  ScalableVideoController::StreamLayersConfig GetScalabilityStructureConfig()
      const {
    ...
    EXPECT_TRUE(info);
    EXPECT_EQ(info->num_spatial_layers, params_.num_spatial_layers);
    return *info;
  }
