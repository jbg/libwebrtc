...
VideoSendStreamImpl::VideoSendStreamImpl(
  ...
  // This seems to be a circular dependency... rtp_video_sender_ points to
  // the encoder feedback via CreateObservers().
  // Move to VideoSendStream - there's no need for it to be owned by this
  // class.
