...
class FrameBuffer2Proxy : public FrameBufferProxy {
 ...
 private:
  ...
  ReceiveStatisticsProxy* const stats_proxy_;
...
VideoReceiveStream2::VideoReceiveStream2(
  ...
  frame_buffer_ = std::make_unique<FrameBuffer2Proxy>(
      clock_, timing_.get(), &stats_proxy_, &decode_queue_, this,
