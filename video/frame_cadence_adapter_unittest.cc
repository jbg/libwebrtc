...
TEST_F(ZeroHertzLayerQualityConvergenceTest,
  ...
  ExpectFrameEntriesAtDelaysFromNow({
      ...
      // 1.5 * kMinFrameDelay: restricts max fps to 5 fps which shuld result
...
TEST_F(ZeroHertzLayerQualityConvergenceTest,
  ...
  ExpectFrameEntriesAtDelaysFromNow({
      ...
      // The 0Hz adapter is reconstructed for 2 fps but does *not* inherit
