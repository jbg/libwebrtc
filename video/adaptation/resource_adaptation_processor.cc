...
void ResourceAdaptationProcessor::OnVideoSourceRestrictionsUpdated(
  ...
  if (reason) {
    ...
    // If a reason did not increase or decrease by 1 and the restrictions were
    // not just reset, the adaptation counters MUST not have been modified and
    // there is nothing to do stats-wise.
