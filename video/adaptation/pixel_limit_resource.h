...
// only resource in play. When multiple resources come in to play some amount of
// toggling is still possible but that is OK for a fake resource and it quickly
// converges on the desired target.
