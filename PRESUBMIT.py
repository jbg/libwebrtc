...
def CheckNoFRIEND_TEST(input_api, output_api,
                       source_file_filter=None):  # pylint: disable=invalid-name
...
def CheckGnChanges(input_api, output_api, source_file_filter=None):
  source_file_filter = lambda x: (input_api.FilterSourceFile(
...
def CheckUnwantedDependencies(input_api, output_api, source_file_filter=None):
...
def CheckJSONParseErrors(input_api, output_api, source_file_filter=None):
...
def CheckOrphanHeaders(input_api, output_api, source_file_filter=None):
  # We need to wait until we have an input_api object and use this
