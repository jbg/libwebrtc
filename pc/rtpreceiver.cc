...
void RtpReceiverInternal::SetChannelCommon(cricket::BaseChannel* channel) {
  if (channel_) {
...
AudioRtpReceiver::AudioRtpReceiver(
    ...
    : RtpReceiverInternal(worker_thread, id, streams, ssrc),
      track_(AudioTrackProxy::Create(
          rtc::Thread::Current(),
          AudioTrack::Create(id,
                             RemoteAudioSource::Create(ssrc, voice_channel)))),
