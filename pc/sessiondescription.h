...
class MediaContentDescription {
 public:
  ...
  void set_extmap_allow_mixed(ExtmapAllowMixed new_extmap_allow_mixed) {
    if (new_extmap_allow_mixed == kMedia && extmap_allow_mixed_ == kSession) {
      // Do not downgrade from session level to media level.
      return;
    }
    extmap_allow_mixed_ = new_extmap_allow_mixed;
  }
  ExtmapAllowMixed extmap_allow_mixed() const { return extmap_allow_mixed_; }
  bool mixed_one_two_byte_header_extensions_supported() const {
    return extmap_allow_mixed_ != kNo;
  }
 ...
 protected:
  ...
  ExtmapAllowMixed extmap_allow_mixed_ = kNo;
};
 ...
 public:
  ...
  void set_extmap_allow_mixed(bool supported) {
    ...
    for (auto& content : contents_) {
      content.media_description()->set_extmap_allow_mixed(media_level_setting);
    }
  }
