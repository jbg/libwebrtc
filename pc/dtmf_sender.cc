...
DtmfSender::DtmfSender(rtc::Thread* signaling_thread,
    ...
    : observer_(nullptr),
      ...
      comma_tone_gap_(kDtmfDefaultCommaGapMs) {
...
bool DtmfSender::InsertDtmf(const std::string& tones,
  ...
  if (duration > kDtmfMaxDurationMs || duration < kDtmfMinDurationMs ||
      inter_tone_gap < kDtmfMinGapMs || comma_tone_gap < kDtmfMinGapMs) {
    RTC_LOG(LS_ERROR)
  ...
  comma_tone_gap_ = comma_tone_gap;
...
int DtmfSender::comma_tone_gap() const {
  return comma_tone_gap_;
}
