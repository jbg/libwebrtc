...
class BaseChannel : public ChannelInterface,
 ...
 public:
  ...
  MediaChannel* media_channel() override {
    // TODO(bugs.webrtc.org/13931): Remove this method.
    return media_send_channel_impl_.get();
  }

  const MediaChannel* media_channel() const override {
    // TODO(bugs.webrtc.org/13931): Remove this method.
    return media_send_channel_impl_.get();
  }
 ...
 protected:
  ...
  bool network_initialized() RTC_RUN_ON(network_thread()) {
    return media_channel()->HasNetworkInterface();
  }
  ...
  // thread. These are used in initializing the subclasses.
