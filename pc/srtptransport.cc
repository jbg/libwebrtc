...
bool SrtpTransport::SetRtpParams(int send_cs,
  ...
  OnNetworkRouteChanged(rtp_packet_transport()->transport_name(),
                        rtp_packet_transport()->GetNetworkRoute());
  return true;
}
...
void SrtpTransport::OnNetworkRouteChanged(std::string transport_name,
