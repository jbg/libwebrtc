...
RTCStatsCollector::PrepareTransceiverStatsInfos_s() const {
  ...
  // Calling GetStats on each media channel and constructing TrackMediaInfoMaps
  // for each transceiver involve the worker thread. By invoking here we can do
  // all this work in a single PostTask.
