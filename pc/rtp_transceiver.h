...
class RtpTransceiver final
 ...
 public:
  ...
  header_extensions_negotiated() const override;
  std::vector<RtpHeaderExtensionCapabilityWithOptionalDirection>
  header_extensions_to_offer() const override;
...
PROXY_METHOD1(webrtc::RTCError,
              ...
              rtc::ArrayView<RtpHeaderExtensionCapabilityWithOptionalDirection>)
PROXY_CONSTMETHOD0(std::vector<RtpHeaderExtensionCapabilityWithDirection>,
