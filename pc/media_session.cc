...
// `codecs` is a full list of codecs with correct payload type mappings;
// `supported_codecs` is a list filtered for the media section`s direction but
// with default payload types.
