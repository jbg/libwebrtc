...
class DtlsSrtpTransportTest : public testing::Test,
 ...
 protected:
  ...
  void MakeDtlsSrtpTransports(FakeDtlsTransport* rtp_dtls1,
    ...
    dtls_srtp_transport1_->SetDtlsTransports(rtp_dtls1, rtcp_dtls1);
    dtls_srtp_transport2_->SetDtlsTransports(rtp_dtls2, rtcp_dtls2);
...
TEST_F(DtlsSrtpTransportTest,
  ...
  dtls_srtp_transport2_->SetDtlsTransports(rtp_dtls4.get(), rtcp_dtls3.get());
