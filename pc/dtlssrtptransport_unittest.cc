...
// Tests if transports are set with RTCP muxing enabled after they already
// finished their handshake, SRTP is set up.
...
// Tests if transports are set with RTCP muxing disabled after they already
// finished their handshake, SRTP is set up.
