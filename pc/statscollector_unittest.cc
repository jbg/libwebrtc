...
TEST_F(StatsCollectorTest, IceCandidateReport) {
  ...
  std::string report_id =
      AddCandidateReport(stats.get(), local, true)->id()->ToString();
  EXPECT_EQ("Cand-" + local.id(), report_id);
  ...
  report_id = AddCandidateReport(stats.get(), remote, false)->id()->ToString();
  EXPECT_EQ("Cand-" + remote.id(), report_id);
