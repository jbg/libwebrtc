...
class JsepTransport : public sigslot::has_slots<> {
 public:
  ...
  // Currenly media_transport can co-exist with RTP / RTCP transports.
  JsepTransport(
 ...
 private:
  ...
  // Optional media transport (experimental). If available it will be used to
  // send / receive encoded audio and video frames instead of RTP.
  // Currenly media_transport can co-exist with RTP / RTCP transports.
