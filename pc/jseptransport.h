...
class JsepTransport : public sigslot::has_slots<>,
 ...
 public:
  ...
  // This is signaled for every change in |media_transport_| state.
  sigslot::signal<> SignalMediaTransportActive;
 ...
 private:
  ...
  // If |media_transport_| is provided, this varable represents the state of
  // media transport.
