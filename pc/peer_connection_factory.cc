...
PeerConnectionFactory::CreatePeerConnectionOrError(
  ...
  std::unique_ptr<Call> call =
      worker_thread()->BlockingCall([this, context, &configuration] {
        return CreateCall_w(context, configuration);
      });
...
std::unique_ptr<Call> PeerConnectionFactory::CreateCall_w(
  ...
  webrtc::Call::Config call_config(context, network_thread());
  ...
  ParseFieldTrial(
      ...
      context.experiments().Lookup("WebRTC-PcFactoryDefaultBitrates"));
