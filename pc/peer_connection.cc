  ...
  rtc::scoped_refptr<ImplicitCreateSessionDescriptionObserver>
      create_sdp_observer(
          new rtc::RefCountedObject<ImplicitCreateSessionDescriptionObserver>(
              ...
              rtc::scoped_refptr<SetLocalDescriptionObserverInterface>(
                  new SetLocalDescriptionObserverAdapter(
                      this, observer_refptr))));
  SetLocalDescriptionParameterlessInternal(create_sdp_observer);
}
...
void PeerConnection::SetLocalDescriptionParameterlessInternal(
  ...
  operations_chain_->ChainOperation(
      [this_weak_ptr = weak_ptr_factory_.GetWeakPtr(),
       create_sdp_observer](std::function<void()> operations_chain_callback) {
        ...
        // operation.
        static_cast<ImplicitCreateSessionDescriptionObserver*>(create_sdp_observer.get())->SetOperationCompleteCallback(
            std::move(operations_chain_callback));
