  ...
  operations_chain_->ChainOperation(
      [this_refptr = rtc::scoped_refptr<PeerConnection>(this), observer_refptr,
       options](std::function<void()> operations_chain_callback) {
        // The operation completes asynchronously. |this_refptr| keeps the
        // PeerConnection alive until the operation is completed. This ensures
        // that CreateOffer() cannot be cancelled.
  ...
  operations_chain_->ChainOperation(
      [this_refptr = rtc::scoped_refptr<PeerConnection>(this), observer_refptr,
       options](std::function<void()> operations_chain_callback) {
        // The operation completes asynchronously. |this_refptr| keeps the
        // PeerConnection alive until the operation is completed. This ensures
        // that CreateAnswer() cannot be cancelled.
...
void PeerConnection::SetLocalDescription(
  ...
  operations_chain_->ChainOperation(
      [this_refptr = rtc::scoped_refptr<PeerConnection>(this), observer_refptr,
       desc_ptr](std::function<void()> operations_chain_callback) {
  ...
  operations_chain_->ChainOperation(
      [this_refptr = rtc::scoped_refptr<PeerConnection>(this), observer,
       desc_ptr](std::function<void()> operations_chain_callback) {
        ...
        // completed, and we can mark this operation as complete.
        operations_chain_callback();
      });
}
