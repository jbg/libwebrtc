...
void PeerConnection::Close() {
  ...
  sdp_handler_.ChangeSignalingState(PeerConnectionInterface::kClosed);
...
RTCError PeerConnection::UpdateSessionState(
  ...
  if (type == SdpType::kOffer) {
    sdp_handler_.ChangeSignalingState(
        source == cricket::CS_LOCAL
    ...
    sdp_handler_.ChangeSignalingState(PeerConnectionInterface::kStable);
