...
DataContentDescription::DataContentDescription() {
  ...
  // we are told what protocol to use via set_protocol or
  // another function calling CreateShimTarget.
  RTC_LOG(LS_ERROR) << "DEBUG: Creating empty DataContentDescription";
}
...
DataContentDescription::DataContentDescription(
  ...
  RTC_LOG(LS_ERROR) << "DEBUG: Creating DataContentDescription from SCTP";
}
