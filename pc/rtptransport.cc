...
void RtpTransport::SetIceRtpTransport(cricket::IceTransportInternal* rtp) {
  SetRtpPacketTransport(rtp);
  rtp->SignalNetworkRouteChanged.connect(this,
                                         &RtpTransport::OnNetworkRouteChange);
}

void RtpTransport::SetIceRtcpTransport(cricket::IceTransportInternal* rtcp) {
  SetRtcpPacketTransport(rtcp);
