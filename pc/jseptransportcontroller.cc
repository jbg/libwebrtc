...
void JsepTransportController::UpdateAggregateStates_n() {
  ...
  std::map<PeerConnectionInterface::IceTransportState, int> ice_state_counts;
  ...
  int total_ice_checking = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportChecking];
  int total_ice_connected = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportConnected];
  int total_ice_completed = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportCompleted];
  int total_ice_failed = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportFailed];
  int total_ice_disconnected = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportDisconnected];
  int total_ice_closed = ice_state_counts
      [PeerConnectionInterface::IceTransportState::kIceTransportClosed];
