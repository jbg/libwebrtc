...
void JsepTransportController::UpdateAggregateStates_n() {
  ...
  if (total_failed > 0) {
    ...
    new_combined_state =
        PeerConnectionInterface::PeerConnectionState::kPeerConnectionFailed;
  } else if (total_ice_disconnected > 0 &&
    ...
    // or "checking" state.
    new_combined_state = PeerConnectionInterface::PeerConnectionState::
    ...
    new_combined_state =
        PeerConnectionInterface::PeerConnectionState::kPeerConnectionConnecting;
    ...
    new_combined_state =
        PeerConnectionInterface::PeerConnectionState::kPeerConnectionConnected;
  } else {
