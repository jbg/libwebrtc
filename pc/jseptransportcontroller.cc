...
void JsepTransportController::UpdateAggregateStates_n() {
  ...
  PeerConnectionInterface::PeerConnectionState new_combined_state =
      PeerConnectionInterface::PeerConnectionState::kPeerConnectionNew;
  ...
  if (total_failed > 0) {
    ...
    new_combined_state = PeerConnectionInterface::kPeerConnectionFailed;
  } else if (total_ice_disconnected > 0 &&
    ...
    // or "checking" state.
    new_combined_state = PeerConnectionInterface::kPeerConnectionDisconnected;
    ...
    new_combined_state = PeerConnectionInterface::kPeerConnectionConnecting;
    ...
    new_combined_state = PeerConnectionInterface::kPeerConnectionConnected;
  } else {
    ...
    // Note that if none of the other conditions hold this is guaranteed to be
    // true.
    new_combined_state = PeerConnectionInterface::kPeerConnectionNew;
  }
