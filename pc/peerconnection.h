...
class PeerConnection : public PeerConnectionInterface,
 ...
 private:
  ...
  RTCError SetCurrentOrPendingLocalDescription(
      std::unique_ptr<SessionDescriptionInterface> desc);
  RTCError SetCurrentOrPendingRemoteDescription(
      std::unique_ptr<SessionDescriptionInterface> desc);
  ...
  RTCError PushdownLocalTransportDescription(
      const cricket::SessionDescription* sdesc,
      cricket::ContentAction action);
  RTCError PushdownRemoteTransportDescription(
      const cricket::SessionDescription* sdesc,
      cricket::ContentAction action);
