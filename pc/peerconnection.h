...
class PeerConnection : public PeerConnectionInterface,
 ...
 private:
  ...
  // Returns the correct transport name for the given media section identified
  // by |mid|.
  // If BUNDLE is enabled, the transport name will be the first mid in the
  // bundle group. Otherwise, the transport name will be the mid.
