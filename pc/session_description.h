...
class DataContentDescription : public MediaContentDescriptionImpl<DataCodec> {
 public:
  ...
  // Exposed for testing - new clients should not use this class.
  ...
  SimulcastDescription& simulcast_description() const override;
 ...
 private:
  ...
  // Helper function for use when caller obviously assumes RTP.
  void EnsureIsRtp();
