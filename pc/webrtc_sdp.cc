...
template <class T>
T GetCodecWithPayloadType(cricket::MediaType type, const std::vector<T>& codecs, int payload_type) {
...
void UpdateCodec(MediaContentDescription* content_desc,
  ...
  U new_codec = GetCodecWithPayloadType(content_desc->type(), static_cast<T*>(content_desc)->codecs(),
                                        payload_type);
...
void UpdateVideoCodecPacketization(VideoContentDescription* video_desc,
  ...
  cricket::VideoCodec codec =
      GetCodecWithPayloadType(video_desc->type(), video_desc->codecs(), payload_type);
...
void UpdateCodec(int payload_type,
  ...
  cricket::AudioCodec codec =
      GetCodecWithPayloadType(audio_desc->type(), audio_desc->codecs(), payload_type);
