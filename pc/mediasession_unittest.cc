...
TEST_F(MediaSessionDescriptionFactoryTest,
  ...
  video_offer->set_mixed_one_two_byte_header_extensions_supported(false);
  audio_offer->set_mixed_one_two_byte_header_extensions_supported(false);
  ...
  EXPECT_FALSE(video_answer->mixed_one_two_byte_header_extensions_supported());
  EXPECT_FALSE(audio_answer->mixed_one_two_byte_header_extensions_supported());

  // Enable mixed one-two byte header support in offer.
  video_offer->set_mixed_one_two_byte_header_extensions_supported(true);
  audio_offer->set_mixed_one_two_byte_header_extensions_supported(true);
  ASSERT_TRUE(offer.get() != NULL);
  std::unique_ptr<SessionDescription> answer_support(
      f2_.CreateAnswer(offer.get(), opts, NULL));
  ...
  EXPECT_TRUE(video_answer->mixed_one_two_byte_header_extensions_supported());
  EXPECT_TRUE(audio_answer->mixed_one_two_byte_header_extensions_supported());
}
