...
// H264 codecs (in addition to profile-level-id). Previously, this was the case,
// so the first H264 codec with the same profile-level-id would match and the
// payload type in the answer would be incorrect.
