...
RTCError PeerConnection::PushdownLocalTransportDescription(
    const SessionDescription* sdesc,
    cricket::ContentAction action) {
  RTC_DCHECK_RUN_ON(signaling_thread());
  RTC_DCHECK(sdesc);
...
RTCError PeerConnection::PushdownRemoteTransportDescription(
    const SessionDescription* sdesc,
    cricket::ContentAction action) {
  RTC_DCHECK_RUN_ON(signaling_thread());
