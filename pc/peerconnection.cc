...
void PeerConnection::CreateAnswer(CreateSessionDescriptionObserver* observer,
  ...
  if (remote_description() && remote_description()->type() != SdpType::kOffer) {
...
void PeerConnection::SetLocalDescription(
  ...
  if (local_description()->type() == SdpType::kAnswer) {
...
void PeerConnection::SetRemoteDescription(
  ...
  if (remote_description()->type() == SdpType::kAnswer) {
    // TODO(deadbeef): We already had to hop to the network thread for
    // MaybeStartGathering...
    network_thread()->Invoke<void>(
        RTC_FROM_HERE, rtc::Bind(&cricket::PortAllocator::DiscardCandidatePool,
...
RTCError PeerConnection::ApplyRemoteDescription(
  ...
  if (remote_description()->type() != SdpType::kOffer &&
...
void PeerConnection::GetOptionsForAnswer(
  ...
  if (remote_description()) {
    ...
    RTC_DCHECK(remote_description()->type() == SdpType::kOffer);
