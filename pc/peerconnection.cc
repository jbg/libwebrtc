...
cricket::IceConfig PeerConnection::ParseIceConfig(
  ...
  cricket::WirelessNetworkPreference network_preference;
  switch (config.network_preference) {
    case PeerConnectionInterface::PREFER_WIFI:
      network_preference = cricket::WirelessNetworkPreference::PREFER_WIFI;
      break;
    case PeerConnectionInterface::PREFER_CELLULAR:
      network_preference = cricket::WirelessNetworkPreference::PREFER_CELLULAR;
      break;
    case PeerConnectionInterface::PREFER_EITHER:
      network_preference = cricket::WirelessNetworkPreference::PREFER_EITHER;
      break;
    default:
      RTC_NOTREACHED();
      network_preference = cricket::WirelessNetworkPreference::PREFER_EITHER;
  ...
  ice_config.network_preference = network_preference;
  return ice_config;
}
