...
class ConnectionContext : public rtc::RefCountInterface {
 public:
  ...
  CallFactoryInterface* call_factory() const { return call_factory_.get(); }
 ...
 private:
  ...
  std::unique_ptr<rtc::NetworkMonitorFactory> network_monitor_factory_;
  ...
  std::unique_ptr<WebRtcKeyValueConfig> trials_;
};
