...
class SrtpTransport : public RtpTransportInternal {
 public:
  ...
  void SetIceRtpTransport(cricket::IceTransportInternal* rtp) override {
    rtp_transport_->SetIceRtpTransport(rtp);
  }

  void SetIceRtcpTransport(cricket::IceTransportInternal* rtcp) override {
    rtp_transport_->SetIceRtpTransport(rtcp);
  }
