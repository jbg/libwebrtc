...
class PeerConnection : public PeerConnectionInternal,
 ...
 public:
  ...
  bool sctp_mode() const { return data_channel_controller_.sctp_mode(); }
  ...
  // Stuff used by the DataChannelController
