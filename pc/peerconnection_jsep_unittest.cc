...
const char kLocalDesc[] =
    "v=0\r\n"
    "o=- 319699601836059222 2 IN IP4 127.0.0.1\r\n"
    "s=-\r\n"
    "t=0 0\r\n"
    "a=group:BUNDLE 0 1\r\n"
    "a=msid-semantic: WMS mesibo\r\n"
    "m=audio 9 UDP/TLS/RTP/SAVPF 111 103 104 9 0 8 106 105 13 110 112 113 "
    "126\r\n"
    "c=IN IP4 0.0.0.0\r\n"
    "a=rtcp:9 IN IP4 0.0.0.0\r\n"
    "a=ice-ufrag:epO5\r\n"
    "a=ice-pwd:fyU9KPe/tQ76+Z5usFJTnzED\r\n"
    "a=ice-options:trickle\r\n"
    "a=fingerprint:sha-256 "
    "64:62:4C:16:E5:D2:D1:97:D7:CC:C9:D7:6E:E1:D4:A9:6B:92:4F:A7:DC:BA:BE:77:"
    "AE:29:B2:43:03:DD:8D:24\r\n"
    "a=setup:active\r\n"
    "a=mid:0\r\n"
    ...
    "a=ssrc:3249443651 cname:JXaKA9/t7cojLTJ/\r\n"
    "a=ssrc:3249443651 msid:mesibo mesibo_an0\r\n"
    "a=ssrc:3249443651 mslabel:mesibo\r\n"
    "a=ssrc:3249443651 label:mesibo_an0\r\n"
    ...
    "a=ssrc-group:FID 1313062553 939875601\r\n"
    "a=ssrc:1313062553 cname:JXaKA9/t7cojLTJ/\r\n"
    "a=ssrc:1313062553 msid:mesibo mesibo_vn0\r\n"
    "a=ssrc:1313062553 mslabel:mesibo\r\n"
    "a=ssrc:1313062553 label:mesibo_vn0\r\n"
    "a=ssrc:939875601 cname:JXaKA9/t7cojLTJ/\r\n"
    "a=ssrc:939875601 msid:mesibo mesibo_vn0\r\n"
    "a=ssrc:939875601 mslabel:mesibo\r\n"
    "a=ssrc:939875601 label:mesibo_vn0\r\n";

const char kRemoteDesc[] =
    "v=0\r\n"
    "o=- 6656252440528718900 2 IN IP4 127.0.0.1\r\n"
    "s=-\r\n"
    "t=0 0\r\n"
    "a=group:BUNDLE 0 1\r\n"
    "a=msid-semantic: WMS mesibo\r\n"
    ...
    "a=rtcp:9 IN IP4 0.0.0.0\r\n"
    "a=ice-ufrag:bU3b\r\n"
    "a=ice-pwd:ODcLCFIKKMmKVJeBcJd6qcKb\r\n"
    "a=ice-options:trickle renomination\r\n"
    "a=fingerprint:sha-256 "
    "42:59:7A:46:2D:90:BD:4D:AB:91:4C:BC:5D:83:C4:8A:0E:61:44:BA:4D:89:3E:6D:"
    "20:0E:5A:E6:D6:2D:17:03\r\n"
    "a=setup:actpass\r\n"
    "a=mid:0\r\n"
    "a=extmap:1 urn:ietf:params:rtp-hdrext:ssrc-audio-level\r\n"
    "a=extmap:9 urn:ietf:params:rtp-hdrext:sdes:mid\r\n"
    "a=sendrecv\r\n"
    "a=msid:mesibo mesibo_ai0\r\n"
    "a=rtcp-mux\r\n"
    "a=rtpmap:111 opus/48000/2\r\n"
    "a=rtcp-fb:111 transport-cc\r\n"
    "a=fmtp:111 minptime=10;useinbandfec=1\r\n"
    ...
    "a=rtpmap:113 telephone-event/16000\r\n"
    "a=rtpmap:126 telephone-event/8000\r\n"
    "a=ssrc:2919579094 cname:ZAbYoHz/FtErENIx\r\n"
    "a=ssrc:2919579094 msid:mesibo mesibo_ai0\r\n"
    "a=ssrc:2919579094 mslabel:mesibo\r\n"
    "a=ssrc:2919579094 label:mesibo_ai0\r\n"
...
TEST_F(PeerConnectionJsepTest, Issue10013) {
  auto caller = CreatePeerConnection();
  auto callee = CreatePeerConnection();
  auto offer = CreateSessionDescription(SdpType::kOffer, kRemoteDesc);
  auto answer = CreateSessionDescription(SdpType::kAnswer, kLocalDesc);
  caller->SetRemoteDescription(std::move(offer));
  caller->SetLocalDescription(std::move(answer));
}
