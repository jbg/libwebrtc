...
static void RemoveRtpHeaderExtensionByUri(
  ...
  media_description->set_rtp_header_extensions(result);
}
...
static void ClearMids(SessionDescriptionInterface* sdesc) {
  ...
  if (audio_content) {
    ...
    audio_content->name = "audio";  // The parser would add this by default.
  ...
  if (video_content) {
    ...
    video_content->name = "video";  // The parser would add this by default.
