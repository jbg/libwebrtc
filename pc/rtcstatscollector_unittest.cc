...
TEST_F(RTCStatsCollectorTest,
  ...
  voice_sender_info_ssrc1.apm_statistics.echo_return_loss =
      rtc::Optional<double>(42.0);
  voice_sender_info_ssrc1.apm_statistics.echo_return_loss_enhancement =
      rtc::Optional<double>(52.0);
