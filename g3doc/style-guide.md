...
[`[[deprecated("reason")]]` attribute][CPP_DEPRECATED] to cause an error when they're used
...
[CPP_DEPRECATED]: https://en.cppreference.com/w/cpp/language/attributes/deprecated
