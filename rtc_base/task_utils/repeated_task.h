...
// will live until it has been stopped or the TaskQueue is destroyed. Note that
// this means that trying to stop the repeated task after the TaskQueue is
// destroyed is an error. Make sure that you know the lifetime of the TaskQueue
// is longer than the returned RepeatedTaskHandle.
template <class Closure>
