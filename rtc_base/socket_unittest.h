...
class SocketTest : public ::testing::Test {
 protected:
  ...
  void TestUdpSocketRecvTimestampUseRtcEpocIPv4();
  void TestUdpSocketRecvTimestampUseRtcEpocIPv6();
 ...
 private:
  ...
  void UdpSocketRecvTimestampUseRtcEpoc(const IPAddress& loopback);
