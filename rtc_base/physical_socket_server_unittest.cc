...
TEST_F(PhysicalSocketTest, UdpSocketRecvTimestampUseRtcEpocIPv4ScmExperiment) {
  MAYBE_SKIP_IPV4;
  webrtc::test::ScopedFieldTrials trial("WebRTC-SCM-Timestamp/Enabled/");
  SocketTest::TestUdpSocketRecvTimestampUseRtcEpocIPv4();
}

TEST_F(PhysicalSocketTest, UdpSocketRecvTimestampUseRtcEpocIPv6ScmExperiment) {
  webrtc::test::ScopedFieldTrials trial("WebRTC-SCM-Timestamp/Enabled/");
  SocketTest::TestUdpSocketRecvTimestampUseRtcEpocIPv6();
}
