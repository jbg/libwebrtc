...
class SingleMessageHandlerWithFunctor : public MessageHandler {
 public:
  template <class ForwardableFunctorT>
  explicit SingleMessageHandlerWithFunctor(ForwardableFunctorT&& functor)
      : functor_(std::forward<ForwardableFunctorT>(functor)) {}
...
// - FunctorT is movable or copyable.
