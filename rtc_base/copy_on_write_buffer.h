...
class CopyOnWriteBuffer {
 public:
  ...
  T* data() {
    ...
    CloneDataIfReferenced(capacity());
 ...
 private:
  ...
  // Create a copy of the underlying data if it is referenced from other Buffer
  // objects or if this object represents a slice of a data in the Buffer.
  void CloneDataIfReferencedOrSliced(size_t new_capacity);
