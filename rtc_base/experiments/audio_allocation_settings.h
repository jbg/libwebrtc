...
class AudioAllocationSettings {
 public:
  ...
  DataRate MinOverheadBitrate() const;
  DataRate MaxOverheadBitrate() const;
 ...
 private:
  ...
  FieldTrialParameter<DataRate> min_overhead_;
  FieldTrialParameter<DataRate> max_overhead_;
};
}  // namespace webrtc
