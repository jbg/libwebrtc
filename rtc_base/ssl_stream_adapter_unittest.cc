...
TEST_F(SSLStreamAdapterTestDTLSCertChain, TwoCertHandshake) {
  ...
  // TODO(bugs.webrtc.org/15153): Fix peer_cert_chain to handle multiple
  // certificates under OpenSSL. Today only the first certificate is returned.
  // Hence putting the chain asserts behind BoringSSL ifdefs.
