...
OpenSSLAdapter::OpenSSLAdapter(AsyncSocket* socket,
    ...
    : SSLAdapter(socket),
      ...
      enable_ocsp_stapling_(true),
      enable_signed_cert_timestamp_(true),
      enable_tls_channel_id_(false),
      enable_grease_(false),
      max_ssl_version_(absl::nullopt),
      tls_alpn_protocols_(absl::nullopt),
      tls_elliptic_curves_(absl::nullopt),
