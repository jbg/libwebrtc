...
#ifndef RTC_BASE_STREAMS_UNDERLYING_TRANSFORMER_H_
#define RTC_BASE_STREAMS_UNDERLYING_TRANSFORMER_H_
...
class UnderlyingTransformer {
 public:
  virtual ~UnderlyingTransformer() = default;
...
#endif  // RTC_BASE_STREAMS_UNDERLYING_TRANSFORMER_H_
