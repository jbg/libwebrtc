...
ABSL_CONST_INIT std::mutex g_log_crit;
}  // namespace
...
ABSL_CONST_INIT LogSink* LogMessage::streams_ = nullptr;
...
LogMessage::~LogMessage() {
  ...
  std::lock_guard<std::mutex> cs(g_log_crit);
...
bool LogMessage::IsNoop(LoggingSeverity severity) {
  return severity < g_dbg_sev && severity < g_min_sev;
}
