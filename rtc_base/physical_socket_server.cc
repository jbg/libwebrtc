...
#if defined(WEBRTC_WIN)
  WSAEVENT GetWSAEvent() override { return return WSA_INVALID_EVENT; }
  SOCKET GetSocket() override { return s_; }
...
uint32_t ListenSocketDispatcher::GetRequestedEvents() {
  // Unconditionally return DE_ACCEPT, even though will not be any events before
  // Listen is called.
  return DE_ACCEPT;
}
