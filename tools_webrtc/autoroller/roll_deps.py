...
class ChromiumRevisionUpdate(object):

  def __init__(self, current_chromium_rev, new_chromium_rev,
      current_third_party_rev,
      new_third_party_rev):
    self.current_chromium_rev = current_chromium_rev
    self.new_chromium_rev = new_chromium_rev
