...
class UploaderOptions():
  ...
  input_results_file:A HistogramSet proto file with output from WebRTC tests.
  output_json_file:Where to write the output (for debugging).
  wait_timeout_sec:Maximum amount of time in seconds that the script will wait
    for the confirmation.
  wait_polling_period-sec:Status will be requested from the Dashboard every
  ...
  wait_polling_period_sec: int = 120
