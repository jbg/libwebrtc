...
class WavWriter final : public WavFile {
 public:
  ...
  WavWriter(const std::string& filename, int sample_rate, size_t num_channels, SampleFormats sample_format = SampleFormats::kInt16);

  // Open a new WAV file for writing.
  WavWriter(FileWrapper file, int sample_rate, size_t num_channels, SampleFormats sample_format = SampleFormats::kInt16);
