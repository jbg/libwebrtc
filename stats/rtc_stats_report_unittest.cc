...
WEBRTC_RTCSTATS_IMPL(RTCTestStats1, RTCStats, kDataChannel, &integer)
...
WEBRTC_RTCSTATS_IMPL(RTCTestStats2, RTCStats, kVideoSource, &number)
...
WEBRTC_RTCSTATS_IMPL(RTCTestStats3, RTCStats, kRemoteCandidate, &string)
